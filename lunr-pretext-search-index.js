...
},
{
  ...
  "body": " Much thanks goes to the students who have helped me work on this textbook. All pictures in Chapter 1, and many in Chapters 2 and 3 were created by Illya Kierkocz. Additional exercises were created by Griffin Bartlett, Luke Daley, and the author. For more exact details about who created which picture or question, please reach out to the author.  "
},
{
  "id": "frontmatter-5-3",
  "level": "1",
  "url": "frontmatter-5-3.html",
  "type": "Subsection",
  "number": "1",
  "title": "Why this book exists",
  "body": " Why this book exists  Too often, mathematics instruction focuses on procedures at the expense of reasons. Students learn to carry out steps but not to explain why those steps work. Teachers in turn may have had little formal opportunity to practice logical reasoning themselves, and so the cycle continues. This text is designed to help break that cycle. By putting logical reasoning at the center, we aim to equip you not just to \"do the math\" but to communicate it in ways that children can understand and question.  "
},
{
  "id": "frontmatter-5-4",
  "level": "1",
  "url": "frontmatter-5-4.html",
  "type": "Subsection",
  "number": "2",
  "title": "What you will find here",
  "body": " What you will find here  Each chapter follows a consistent structure that is meant to make reasoning explicit:   Objectives at the start of sections so you always know what you are aiming for.  Definitions presented alongside examples and non-examples , so that meanings are sharpened rather than left vague.  Exercises that ask not only for answers and calculations but also for explanations, counterexamples, and critiques of reasoning.  Assemblages (Notes for Deeper Understanding) that pause to examine subtleties, common mistakes, and extensions.  Visual tools and pictures such as Venn diagrams, and base-block diagrams to link mathematical ideas and mathematical notation.  Explanatory and critical thinking questions that invite you to evaluate flawed arguments, revise imprecise statements, and supply justifications of your own.   These features are not add-ons. They are deliberately chosen to support the goal of learning mathematics through reasoning and communication.  "
},
{
  "id": "frontmatter-5-5",
  "level": "1",
  "url": "frontmatter-5-5.html",
  "type": "Subsection",
  "number": "3",
  "title": "A note on this version",
  "body": " A note on this version  This is a beta version of the textbook. That means it will continue to change. Typos will be corrected, explanations will be refined, and examples may be replaced or improved. In particular, pictures are still to be added for Section 5.3 onwards, as well as solutions for exercises that appear in the book. Your feedback, whether as an instructor or as a student working through these materials, will be part of how this book changes and develops.  "
},
{
  "id": "subsec-WhyLogic",
  "level": "1",
  "url": "subsec-WhyLogic.html",
  "type": "Subsection",
  "number": "4",
  "title": "Why Logical Reasoning Comes First",
  "body": " Why Logical Reasoning Comes First  A central design decision in this textbook is to foreground logical reasoning. Many existing resources for future teachers emphasize procedures or content knowledge while treating reasoning as a secondary concern. Yet a wide body of research shows that developing logical reasoning early and consistently improves not only students’ mathematical learning but also their ability to apply mathematics in science, teaching, and everyday contexts.  Studies have long demonstrated that reasoning ability is a strong predictor of achievement across STEM subjects. Johnson and Lawson (1998) showed that students with stronger logical reasoning outperformed peers in both expository and inquiry biology classes, regardless of prior content knowledge. Similarly, Bird (2010) found that logical reasoning ability predicted chemistry achievement, suggesting that such skills transfer across domains. These findings reinforce the idea that logical reasoning is not a luxury but a necessity for success in technical fields.  Within mathematics education, researchers emphasize reasoning as the backbone of authentic mathematical activity. Stylianides (2007) argues that proof and proving must be a central part of school mathematics, not an afterthought. Herbst and Chazan (2003) illustrate how teachers’ decisions about engaging students in proof reveal the practical challenges of classroom implementation, yet also the importance of giving students opportunities to reason mathematically. Without such experiences, students often rely on authority rather than argument when evaluating claims (Inglis, Mejía-Ramos, and Simpson, 2009).  Logical reasoning is also a foundation for learning advanced mathematics. Inglis and Simpson (2008) showed that conditional inference skills are strongly tied to success in advanced study, while Sweller’s (1988) cognitive load theory highlights that teaching reasoning explicitly reduces extraneous mental effort, freeing capacity for deeper understanding. Attridge and Inglis (2013) and related studies (e.g., Attridge, Doritou, and Inglis, 2015; Cresswell and Speelman, 2020) further demonstrate that sustained study of mathematics strengthens general reasoning skills, supporting the claim that teaching logic benefits students beyond mathematics itself.  These arguments are echoed in teacher education research. Ball, Thames, and Phelps (2008) describe how content knowledge for teaching is distinct from disciplinary knowledge, requiring the ability to explain, justify, and reason in ways accessible to learners. Boaler (2002) provides evidence that classrooms emphasizing reasoning and discussion lead to richer, longer-lasting understanding than traditional rote approaches. Professional organizations likewise stress reasoning: the National Council of Teachers of Mathematics (2014) lists it as a guiding principle for ensuring mathematical success for all.  For these reasons, this book begins not with rules for computation but with logic, quantified statements, and conditional reasoning. By making reasoning the entry point, we aim to give future teachers the tools to articulate, analyze, and justify mathematics for themselves and for their students.  References:   Ball, D. L., Thames, M. H., & Phelps, G. (2008). Content knowledge for teaching: What makes it special? Journal of Teacher Education, 59 (5), 389–407.  Bird, L. (2010). Logical reasoning ability and student achievement in college chemistry. Journal of Chemical Education, 87 (5), 541–546.  Boaler, J. (2002). Experiencing School Mathematics (Rev. ed.). Mahwah, NJ: Lawrence Erlbaum.  Herbst, P., & Chazan, D. (2003). Exploring the practical rationality of mathematics teaching through conversations about videotaped episodes. For the Learning of Mathematics, 23 (1), 2–14.  Inglis, M., & Simpson, A. (2008). Conditional inference and advanced mathematical study. Educational Studies in Mathematics, 67 (3), 187–204.  Inglis, M., Mejía-Ramos, J. P., & Simpson, A. (2009). Modelling mathematical argumentation: The influence of authority on the evaluation of arguments. Cognition and Instruction, 27 (1), 25–50.  Johnson, M. A., & Lawson, A. E. (1998). What are the relative effects of reasoning ability and prior knowledge on biology achievement in expository and inquiry classes? Journal of Research in Science Teaching, 35 (1), 89–103.  National Council of Teachers of Mathematics. (2014). Principles to Actions: Ensuring Mathematical Success for All . Reston, VA: NCTM.  Stylianides, A. J. (2007). Proof and proving in school mathematics. Journal for Research in Mathematics Education, 38 (3), 289–321.  Sweller, J. (1988). Cognitive load during problem solving: Effects on learning. Cognitive Science, 12 (2), 257–285.  Attridge, N., & Inglis, M. (2013). Advanced mathematics improves reasoning skills. PLOS ONE, 8 (8), e68385.  Attridge, N., Doritou, M., & Inglis, M. (2015). The effect of studying pure mathematics on students’ proof comprehension. Research in Mathematics Education, 17 (1), 20–37.  Cresswell, C., & Speelman, C. P. (2020). Does mathematics training lead to better logical thinking? Psychonomic Bulletin & Review, 27 (4), 784–793.   "
},
{
  "id": "IntroToLogic",
  "level": "1",
...
{
  "id": "open-sentences-exercises",
  "level": "2",
  "url": "IntroToLogic.html#open-sentences-exercises",
  "type": "Checkpoint",
  "number": "1.1.6",
  "title": "",
  "body": " Answer the following questions about open sentences . Recall that an open sentence is a mathematical statement containing one or more variables that becomes either true or false when specific values are substituted for the variables.    Determine whether each of the following is an open sentence:          For each open sentence below, state whether it is true or false when the given value is substituted for the variable.   when  when  when     Write an open sentence that describes each situation:   The cost of tickets if each ticket costs $12.  The area of a square with side length .     Suppose is the open sentence “ is a prime number.” List three values of that make true and three that make it false.        Open  Not open(true)  Open  Not open (false)      True  False  True           True examples: . False examples: .     "
},
{
...
{
  "id": "sec-ConditionalStatements-3-3",
  "level": "2",
  "url": "sec-ConditionalStatements.html#sec-ConditionalStatements-3-3",
  "type": "Checkpoint",
  "number": "1.2.1",
  "title": "",
...
},
{
  ...
  "number": "1.2.5",
  "title": "",
  "body": " Is the conditional statement \"if is a whole number then is a prime number\" always true? Remember, a prime number is a number divisible by exactly two numbers, 1 and itself.   It is not! However, it may take a while to find a counterexample. If we let we find that is indeed prime. For example, if then and you can check that 53 is a prime number. However, when , we have that and so is not a prime number.   "
},
{
...
},
{
  ...
  "number": "1.3.7",
  "title": "",
  "body": " Let A,B,C be sets that aren't the empty set (so ). Show that if and then .   Note that this is an if-then statement. So we need to show that it's never the case that the if-part is true and the then-part is false. But, in the definition of subsets we have additional if-then statements as well, so we have to be careful with these \"nested\" conditional statements.  Let's assume the if-part is true: that and . So this means that if then (since A is a subset of B) and if then (since B is a subset of C).  We need to show that the then-part is true; that A is a subset of C, so if then .  So now, using the if-part assumption, let's show that the then-part is true. Let . By our assumption that we know . Now, by the second part of our assumption, that we know that .  Since we started with an element of A and showed that it must be an element of C, we have shown the then-part; that , and this means we've proved that the if-then statement is always true.  Note that you can see this visually using the following Venn diagram:    Inclusion diagram for A, B, and C above     "
},
{
...
{
  "id": "def-setcomplement",
  "level": "2",
  "url": "sec-Sets.html#def-setcomplement",
  "type": "Definition",
  "number": "1.3.13",
  "title": "",
  "body": "  Let A be a set. We say the set complement , written , is the set of all elements in the universe not in A. In set notation,    "
},
{
...
},
{
  ...
  "number": "2.1.3",
  "title": "",
  "body": "      Let and be expressions with . For any expression with a single placeholder “ ”, write for the result of uniformly replacing every free occurrence of the placeholder by , and similarly for . Then For example, if , then where .     If is an equation, and is any number (or variable that represents a number) then                   as long as    We call this the property of arithmetic equality.       "
},
{
...
{
  "id": "sec-SolvingEquations",
  "level": "1",
  "url": "sec-SolvingEquations.html",
  "type": "Section",
  "number": "2.2",
  "title": "Solving Equations",
  "body": " Solving Equations   Solving Equations   This section introduces linear equations and systems of equations, along with formal methods for solving them using algebraic reasoning grounded in equality.    define expressions, terms, coefficients, constants, and linear equations; distinguish linear from non-linear equations using structure  solve linear equations in one variable using arithmetic operations and properties of equality; verify solutions by substitution  define a system of equations as a collection of simultaneous equalities and solve 2-by-2 linear systems using substitution and elimination methods  explain why the substitution and elimination methods preserve equality using the substitution and arithmetic properties of equality  determine the number of solutions to a system (none, one, or infinitely many) based on the resulting equations during solving    By the end of this section, students will solve and interpret linear equations and systems using formal reasoning, substitution, elimination, and analysis of solution types.     In order to solve problems, it helps to be comfortable solving algebraic equations. In this section we will first talk about solving algebraic equations of a certain type (called linear equations), solving multiple linear equations at the same time, and then talking about some problem solving strategies that you can use to try and get a handle on a problem where the answer and\/or approach isn't immediately obvious.  First, let's give somewhat careful definitions of the objects we care about in equations, and the types of equations we wish to solve. For this section, all coefficients of variables will be integers (that is, positive or negative whole numbers) but some of the solutions to our equations may be rational numbers. In general, these techniques will work with any real numbers in most situations.    An expression is a combination of mathematical symbols without a relational symbol (e.g. ) symbol relating it to another combination of mathematical symbols. A term is an expression that does not include a addition or subtraction operation (outside of necessary brackets). A coefficient of a term that includes a variable is the number that variable is multiplied by. Terms only containing numbers are called constants.   An equation is two equal expressions with an equal sign between them. To solve an equation for a variable means to perform arithmetic operations on both sides of the equation (while maintaining equality) so that the equation is now in the form . Note that if there is only one variable, specifying the variable is usually omitted.    Consider the equation which is made of two expressions, and . In the term on the left hand side (or LHS) of the coefficient is , and in the term on the right hand side (or RHS) of the equation the coefficient is (here, we are viewing as . We will be more precise about this later in the book.)  Sometimes we can have unknown coefficients even in terms with variables, but we specify that these are indeed coefficients. For example, we could have the expression where we are thinking of as our variables and as our coefficients.      An equation over one (or more) variables is called a linear equation exactly when every term of the equation has at most one variable in it, and that variable has an exponent of .     is a linear equation since each term has (at most) one copy of .  Similarly, is another linear equation since both and have exactly one copy of in them, and has no 's or 's.  Now a non-example: is *not* a linear equation. Here there are two problems (note that just one is enough to disqualify it from being a linear equation): the first term has two variables in it, and . Also the second term has two copies of multiplied together, since by the definition of exponents       Solving One Equation  Before we get into the idea of translating a \"real world\" problem into the language of mathematics, we'll go over some very important skills to solve many of these problems, which is solving linear equations (or systems of equations). Let's start with the simplest of cases: solving one equation with one variable.  Let be the symbol for our variable, and let be our coefficients. After collecting like terms, any linear equation can be written in the form . As long as we can follow these following steps (called an algorithm) to solve for our variable .    Subtract and from both sides of the equation. This gives us       Divide everything on both sides by the coefficient . This gives us   Cancelling out the we have     We could just memorize the formula above, but there are so many different situations that arise in mathematics that it isn't feasible to remember everything. However, if you have a strong knowledge of the ideas behind equality and arithmetic of equations, you can recreate this when the need arises.   What number can we substitute in for to solve the equation ?   Let's solve . The easiest way to view this is asking \"what number can I add to 5 to get 8\". We can formally solve for here by subtracting 5 from both sides:  We can solve this using the general algorithm above by viewing the equation as . Then    What number can we substitute in for to solve the equation ?   We can solve by first expanding out the brackets and then combining like terms so that the equation is in the standard form given in the algorithm:  Noting that we can view the RHS of the equation as , we can now use our algorithm above, giving us   We can check our answers by substituting our solution for the variable and making sure that equality holds. For the second equation we have    Since we do indeed have equality our solution is correct.     Solve the following linear equations. Check your work by substituting your answer into the original equation and checking that equality holds.                                                     Intro to Systems Of Equations  In many scenarios, we are given two (or more) relationships between two (or more) unknown quantities and we need to use these to find the unknown quantities that satisfy these relationships.   A typical problem might look like this:  On Monday, you spend to buy two medium coffees and one pizza burger. On Tuesday, you spend to buy three medium coffees and two pizza burgers. How much is one medium coffee, and how much is one pizza burger?  Let's define the price of a medium coffee (dollars) and the price of a pizza burger (dollars). We can translate the two sentences above to the equations    Here, we can check that if a medium coffee is $2.50 and a pizza burger is $4, that is and , both equations are satisfied, and thus both of the sentences above are true:     In this section, we will learn some methods of solving problems like finding these quantities in the example above. Note that we will limit our study to situations with linear equations and variables (which we call \"2 by 2 systems of equations\") but these methods can be expanded to solve larger systems.  First of all, let's define a system of equations. Note that unless otherwise stated, all equations are linear equations.    A system of equations is a set of equations where equality holds in each of these simultaneously; that is, all equations are true at the same time.    The two equations in the previous example are a system of equations. We know that two coffees and two pizza burgers coming to $9 is true, and we also know that similarly for the other equation. So both equations are true simultaneously.      Substitution  We can use the ideas of equality to help us solve systems of equations. Remember from , when two expressions equal, we can substitute one for the other whenever it is convenient. The idea is that since we know how to solve one equation with one variable, so we want to convert a 2 by 2 system of equations into one equation with one variable via substitution. Let's look at in the previous section:    We have the system    Notice that both equations have the variables and in them. If we could \"substitute out\" one of the variables in terms of the other by first solving one of the equations for one of the variables, then we would be in a familiar situation with one equation and one variable. This will be our goal.  There isn't a \"correct\" choice of variable to solve for (any will indeed do!) we notice it seems easiest to solve for in the first equation, as it has a coefficient of , so we do not have to divide at the end to solve for . Solving for in the first equation we have   Now any time we see a in an equation we can replace, or \"substitute\" it with . Let's do this substitution in the second equation:   Here we have one equation with the one variable , so we can use the steps to solve this from the previous section:       Describe the steps in each line of the previous part of this example.   Now that we know we can substitute this in to either equation to solve for our other unknown, We will substitute this into the first equation:      Describe the steps in each line of the previous part of this example.   Now that we have values for all of our variables, we have solved this system of equations. We can check our work by substituting both values into the other equation to make sure equality does indeed hold (as we want both equations to be true simultaneously.)     Since we do indeed achieve equality in both equations, we have our solution.  Let's write these steps as an algorithm:    Choose one of the variables in one of the equations.    Solve the equation for this variable.    Substitute this into the second equation for the solved variable  Simplify this equation. You now have one equation with at most one variable. If you have no variables left, you either have infinitely many solutions or no solutions (we will be able to tell which later in the chapter) and you are done.    If it still exists, solve this equation for the variable. You should have some number.    Substitute this number into either equation and solve for the remaining variable.    Check your work by substituting the solved values for both variables into the equation not used in the previous step. If you do indeed have equality, your solution is a solution for the system of equations.   Solve the following systems of equations. Check your work to make sure the solution is correct:               Elimination  There is another method for solving systems of equations that involves cleverly adding or subtracting multiples of one equation from another. We will explore why this method works, but first we will see the method in action:   Let's look at the same example as in the previous sections; that is, the system of equations    Let's subtract two times the first equation from the second equation (we'll write this as II - 2I, where I is the first equation and II is the second) by performing the operations on either side of the equals sign separately; when we do that, we will \"eliminate\" the variable from the second equation, and then we'll be left with one equation with one variable:      Now that we know we can substitute that in to either equation and solve for , similarly to the previous example. Thus we have .   As you can see, both methods give the same answer (which is a good thing, of course!). But why does this method work? We will give an example in the case of subtraction, but any operation will work. Note that in practice, addition and subtraction are the most useful in these scenarios.  Imagine we had a system of two equations. We will call the left hand sides of the first and second equation and , respectively. Similarly, we will call the right hand sides and . (Note that in our previous example and ). We can view the system in general as  and  By the property of arithmetic equality, we can subtract from both sides of Equation I. Thus:   Now since we can use the property of substitution to substitute for in the right hand side:   Thus, we have subtracted Equation II from Equation I and showed that the idea of elimination makes sense.   Use the above explanation as a guide to justify that if and then .   A few notes:   The method of elimination is more useful when you have larger systems of equations with more equations and\/or more variables. In the case, substitution is generally easy enough to do. However, it is good practice to be able to use the elimination method, as it is extremely more efficient and useful than substitution in these larger systems.    You can eliminate any variable using any equation in your system that you want. It's usually a good idea to choose a variable with small\/easy-to-work-with coefficients, but if you choose another variable, you will still get the correct result.    Once you choose a variable to eliminate, a common and useful technique is to multiply each equation by the coefficient of the variable in the other equation, and then add or subtract to eliminate that variable.      Let's solve the system    We will eliminate the variable . Note that in Equation I the coefficient of is 3, and in Equation II it is -1. We want to eliminate this variable, so we need to multiply our equation by a number so that the coefficients of in both equations are of opposite sign. To make them opposites, we can multiply Equation II by 3:    Now Equation I is and our new equation is . If we add them, the -terms cancel:   Note that we need to add both the left hand sides    Now we can solve this equation using our usual methods for one equation and one variable.   Having found , we can now substitute into either original equation. Using Equation II:      Therefore, the solution is . Each step used only arithmetic operations on both sides of the equations and the fact that adding or subtracting equal quantities preserves equality—so the “elimination” of left us with a single-variable equation. We could have eliminated instead and we would, of course, find the same solution to this system.   Elimination also works for systems that have three or more equations and variables. By combining equations to remove one variable at a time, you can reduce a large system to a single-variable equation and then \"back-substitute\" one equation at a time to find the remaining unknowns. Those techniques are very powerful for handling larger systems, but we will not go further here.   How Many Solutions Does a System of Equations Have  In systems of equations, there are three possibilities of the number of solutions there are; either the system has exactly one solution, exactly zero solutions, or infinitely many solutions. We've seen what happens when a system has exactly one solution, so we will now look at cases where there are either no or infinitely many solutions.   Consider the following system:    Solve this system using either substitution or elimination. What do you notice?   Did you see that both of the variables are eliminated at the same time? In fact, you'll end up with some nonsense equation like or or some other obvious nonsense (depending on how you tried to solve the system). For what values of does your nonsense equation hold? None! So in this case there are exactly no solutions.  In fact, you may have noticed that if we divided Equation II by -2 we obtain the system  There is no way that can equal both 7 and -2 at the same time.     Make two different systems of two equations with two variables that have no solutions. Try to solve them using both substitution and elimination to see what happens.  Consider the following system:    Solve this system using either substitution or elimination. What do you notice?   Like the previous example, both variables are eliminated at the same time. However, unlike the example above, here we're left with an equation that is always true, like or or something similar. This means that introducing the second equation did not reduce the number of solutions for this system. In fact, we're free to choose one of or and then we can determine the other. For example if then you can check that . So we have infinitely many pairs of numbers that solve this system.  Can you find three other pairs of numbers that are solutions?  In fact, you may have noticed that if we divided Equation II by 2 we obtain the system  Of course, this is just two copies of the same equation!    Make two different systems of two equations with two variables that have infinitely many solutions. Try to solve them using both substitution and elimination to see what happens. Then find at least two different solutions for each system you made.  Putting this all together, a 2x2 system of equations has:  No solutions if, when solving the system, you obtain a \"nonsense\" equation without variables, for example .  Infinitely many solutions if, when solving the system, you obtain an equation without variables that is always true, for example .  Exactly one solution in every other case.      "
},
{
  "id": "objectives-SolvingEquations",
  "level": "2",
  "url": "sec-SolvingEquations.html#objectives-SolvingEquations",
  "type": "Objectives",
  "number": "2.2",
  "title": "Solving Equations",
  "body": " Solving Equations   This section introduces linear equations and systems of equations, along with formal methods for solving them using algebraic reasoning grounded in equality.    define expressions, terms, coefficients, constants, and linear equations; distinguish linear from non-linear equations using structure  solve linear equations in one variable using arithmetic operations and properties of equality; verify solutions by substitution  define a system of equations as a collection of simultaneous equalities and solve 2-by-2 linear systems using substitution and elimination methods  explain why the substitution and elimination methods preserve equality using the substitution and arithmetic properties of equality  determine the number of solutions to a system (none, one, or infinitely many) based on the resulting equations during solving    By the end of this section, students will solve and interpret linear equations and systems using formal reasoning, substitution, elimination, and analysis of solution types.   "
},
{
  "id": "def-TermsEtc",
  "level": "2",
  "url": "sec-SolvingEquations.html#def-TermsEtc",
  "type": "Definition",
  "number": "2.2.1",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-SolvingEquations.html#def-LinearEquation",
  "type": "Definition",
  "number": "2.2.3",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-SolvingEquations.html#subsec-SolvingOneEquation-6",
  "type": "Example",
  "number": "2.2.5",
  "title": "",
  "body": " What number can we substitute in for to solve the equation ?   Let's solve . The easiest way to view this is asking \"what number can I add to 5 to get 8\". We can formally solve for here by subtracting 5 from both sides:  We can solve this using the general algorithm above by viewing the equation as . Then    What number can we substitute in for to solve the equation ?   We can solve by first expanding out the brackets and then combining like terms so that the equation is in the standard form given in the algorithm:  Noting that we can view the RHS of the equation as , we can now use our algorithm above, giving us   We can check our answers by substituting our solution for the variable and making sure that equality holds. For the second equation we have    Since we do indeed have equality our solution is correct.   "
},
{
  "id": "subsec-SolvingOneEquation-7",
  "level": "2",
  "url": "sec-SolvingEquations.html#subsec-SolvingOneEquation-7",
  "type": "Checkpoint",
  "number": "2.2.6",
  "title": "",
  "body": " Solve the following linear equations. Check your work by substituting your answer into the original equation and checking that equality holds.                                                  "
},
{
  "id": "ex-2var2eq",
  "level": "2",
  "url": "sec-SolvingEquations.html#ex-2var2eq",
  "type": "Example",
  "number": "2.2.7",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-SolvingEquations.html#def-SystemOfEquations",
  "type": "Definition",
  "number": "2.2.8",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-SolvingEquations.html#subsec-Substitution-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "substitution. "
},
{
  ...
  "level": "2",
  "url": "sec-SolvingEquations.html#subsec-Substitution-17",
  "type": "Checkpoint",
  "number": "2.2.10",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-SolvingEquations.html#subsec-Substitution-22",
  "type": "Checkpoint",
  "number": "2.2.11",
  "title": "",
  "body": " Describe the steps in each line of the previous part of this example.  "
},
{
  ...
  "level": "2",
  "url": "sec-SolvingEquations.html#subsec-Substitution-29-7",
  "type": "Checkpoint",
  "number": "[STRUCT].11",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-SolvingEquations.html#subsec-Elimination-3",
  "type": "Example",
  "number": "2.2.12",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-SolvingEquations.html#subsec-Elimination-11",
  "type": "Checkpoint",
  "number": "2.2.13",
  "title": "",
...
{
  "id": "subsec-Elimination-13",
  "level": "2",
  "url": "sec-SolvingEquations.html#subsec-Elimination-13",
  "type": "Example",
  "number": "2.2.14",
  "title": "",
  "body": " Let's solve the system    We will eliminate the variable . Note that in Equation I the coefficient of is 3, and in Equation II it is -1. We want to eliminate this variable, so we need to multiply our equation by a number so that the coefficients of in both equations are of opposite sign. To make them opposites, we can multiply Equation II by 3:    Now Equation I is and our new equation is . If we add them, the -terms cancel:   Note that we need to add both the left hand sides    Now we can solve this equation using our usual methods for one equation and one variable.   Having found , we can now substitute into either original equation. Using Equation II:      Therefore, the solution is . Each step used only arithmetic operations on both sides of the equations and the fact that adding or subtracting equal quantities preserves equality—so the “elimination” of left us with a single-variable equation. We could have eliminated instead and we would, of course, find the same solution to this system.  "
},
{
  "id": "sec-SolvingEquations-8-3",
  "level": "2",
  "url": "sec-SolvingEquations.html#sec-SolvingEquations-8-3",
  "type": "Example",
  "number": "2.2.15",
  "title": "",
  "body": " Consider the following system:    Solve this system using either substitution or elimination. What do you notice?   Did you see that both of the variables are eliminated at the same time? In fact, you'll end up with some nonsense equation like or or some other obvious nonsense (depending on how you tried to solve the system). For what values of does your nonsense equation hold? None! So in this case there are exactly no solutions.  In fact, you may have noticed that if we divided Equation II by -2 we obtain the system  There is no way that can equal both 7 and -2 at the same time.   "
},
{
  "id": "sec-SolvingEquations-8-4",
  "level": "2",
  "url": "sec-SolvingEquations.html#sec-SolvingEquations-8-4",
  "type": "Checkpoint",
  "number": "2.2.16",
  "title": "",
  "body": " Make two different systems of two equations with two variables that have no solutions. Try to solve them using both substitution and elimination to see what happens. "
},
{
  "id": "sec-SolvingEquations-8-5",
  "level": "2",
  "url": "sec-SolvingEquations.html#sec-SolvingEquations-8-5",
  "type": "Example",
  "number": "2.2.17",
  "title": "",
  "body": "Consider the following system:    Solve this system using either substitution or elimination. What do you notice?   Like the previous example, both variables are eliminated at the same time. However, unlike the example above, here we're left with an equation that is always true, like or or something similar. This means that introducing the second equation did not reduce the number of solutions for this system. In fact, we're free to choose one of or and then we can determine the other. For example if then you can check that . So we have infinitely many pairs of numbers that solve this system.  Can you find three other pairs of numbers that are solutions?  In fact, you may have noticed that if we divided Equation II by 2 we obtain the system  Of course, this is just two copies of the same equation!  "
},
{
  "id": "sec-SolvingEquations-8-6",
  "level": "2",
  "url": "sec-SolvingEquations.html#sec-SolvingEquations-8-6",
  "type": "Checkpoint",
  "number": "2.2.18",
  "title": "",
  "body": " Make two different systems of two equations with two variables that have infinitely many solutions. Try to solve them using both substitution and elimination to see what happens. Then find at least two different solutions for each system you made. "
},
{
  "id": "FutureIdeas",
  "level": "1",
  "url": "FutureIdeas.html",
  "type": "Section",
  "number": "2.3",
...
{
  "id": "sec-2_1NumberSystemsAndPlaceValue-9-9",
  "level": "2",
  "url": "sec-2_1NumberSystemsAndPlaceValue.html#sec-2_1NumberSystemsAndPlaceValue-9-9",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "digits "
...
{
  "id": "sec-2_1NumberSystemsAndPlaceValue-9-10",
  "level": "2",
  "url": "sec-2_1NumberSystemsAndPlaceValue.html#sec-2_1NumberSystemsAndPlaceValue-9-10",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "base "
...
{
  "id": "sec-2_1NumberSystemsAndPlaceValue-9-24",
  "level": "2",
  "url": "sec-2_1NumberSystemsAndPlaceValue.html#sec-2_1NumberSystemsAndPlaceValue-9-24",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-2_1NumberSystemsAndPlaceValue.html#subsec-ConvertingFromBaseTen-3",
  "type": "Example",
  "number": "3.1.2",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-2_1NumberSystemsAndPlaceValue.html#subsec-ConvertingFromBaseTen-5",
  "type": "Example",
  "number": "3.1.3",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-2_1NumberSystemsAndPlaceValue.html#subsec-ConvertingFromBaseTen-10",
  "type": "Checkpoint",
  "number": "3.1.4",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-2_1NumberSystemsAndPlaceValue.html#subsec-ConvertingToBaseTen-3",
  "type": "Example",
  "number": "3.1.5",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-2_1NumberSystemsAndPlaceValue.html#subsec-ConvertingToBaseTen-5",
  "type": "Example",
  "number": "3.1.6",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-2_1NumberSystemsAndPlaceValue.html#subsec-BaseTwelve-6",
  "type": "Example",
  "number": "3.1.7",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-2_1NumberSystemsAndPlaceValue.html#subsec-BaseTwelve-7",
  "type": "Example",
  "number": "3.1.8",
  "title": "",
  "body": " Now let's convert a base twelve number to base ten. Let's try . Using the algorithm above:    "
},
{
...
{
  "id": "subsec-Subtraction-10-2",
  "level": "2",
  "url": "sec-ArithmeticOperations.html#subsec-Subtraction-10-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "if and only if "
...
{
  "id": "subsec-Subtraction-10-6",
  "level": "2",
  "url": "sec-ArithmeticOperations.html#subsec-Subtraction-10-6",
  "type": "Checkpoint",
  "number": "3.2.8",
  "title": "",
  "body": "How can you express the two related subtraction problems above in terms of inequalities?  "
},
{
...
},
{
  ...
  "number": "3.3.1",
  "title": "",
  "body": " Be careful when you see expressions like . It is a very common error to add the first, which is incorrect as it does not follow our order of operations. Of course, we should have   "
},
{
  "id": "def-Closure",
  "level": "2",
...
},
{
  ...
  "number": "3.3.4",
  "title": "",
  "body": "  We say an operation is commutative exactly when it's the case that when then ; that is, (order of performing the operation doesn't matter).    In , addition and multiplication are commutative. For example, and . We can view these pictorially:    4+11 and 11+4 on a number line    3x7 and 7x3 using area model    Let's move to the set so that subtraction is closed and our subtractions make sense. Subtraction is *not* a commutative operation since, as a counterexample, but . Similarly, division in the set is not commutative.   "
},
{
...
},
{
  ...
  "number": "3.3.10",
  "title": "",
  "body": "  Let be a number. Then is the additive inverse or negative of if and only if .    In the set of integers, is the negative of since . This also means that is the negative of .    However, has no negative in the set of whole numbers, since there is no such that . So depending on the set you are working with, negatives may or may not exist.   "
},
{
  ...
  "number": "3.3.13",
  "title": "",
  "body": "  Let be a number. Then is the multiplicative inverse or reciprocal of if and only if .    In the set of rational numbers, or fractions, is the reciprocal of since . This also means that is the reciprocal of .    Note that in any set, does not have a reciprocal, since there is no number such that since we know that for any choice of (of course, we know this fact is true, but we will carefully show *why* it is true later in this section.)   "
},
{
...
},
{
  ...
  "number": "4.2.5",
  "title": "",
  "body": " Let's subtract using the same change algorithm. We line up the two numbers as usual (and we'll keep block representations along with our calculation to see the process in a pictorial way)    (for accessibility)    Starting at the ones place, we notice that the top digit is smaller than the bottom digit, we add 3 to both the top and bottom numbers ( ) to obtain the new subtraction problem . Notice that the bottom digit is now 0, so this will eventually make subtraction easy (at the cost of doing a bit of addition)    (for accessibility)      (for accessibility)    Now we move left to the tens place. As before, we notice that the top digit is less than the bottom digit, so add the opposite digit number of tens to both numbers. Since the opposite of is we add to both numbers ( ) to make the new subtraction problem     (for accessibility)      (for accessibility)    Moving to the hundreds place, since the top digit is less than the bottom digit, we add the opposite number of hundreds, that is , to both numbers to obtain the new subtraction problem .    (for accessibility)    Moving left to the thousands place, we notice that the top digit is greater than or equal to (in this case, greater than) the bottom digit, so we do nothing. Also, there are no non-zero digits in any places to our left (thousands is the largest place in our numbers) so we can now easily subtract place by place to obtain our final answer     (for accessibility)    "
},
{
...
{
  "id": "subsec-EqualAdditionsAlgorithm-6",
  "level": "2",
  "url": "sec-SubtractionAlgorithms.html#subsec-EqualAdditionsAlgorithm-6",
  "type": "Checkpoint",
  "number": "4.2.8",
  "title": "",
  "body": " We have covered four different subtraction algorithms so far. Analyze each algorithm indicating what you think are the pros and cons of each.  "
},
{
...
{
  "id": "subsec-MultiplicationInBaseTwelve-11",
  "level": "2",
  "url": "sec-MultiplicationAlgorithms.html#subsec-MultiplicationInBaseTwelve-11",
  "type": "Checkpoint",
  "number": "4.3.4",
  "title": "",
  "body": " Complete the entire multiplication table in base twelve for single digits.     (for accessibility)     "
},
{
  "id": "subsec-MultiplicationInBaseTwelve-13",
  "level": "2",
  "url": "sec-MultiplicationAlgorithms.html#subsec-MultiplicationInBaseTwelve-13",
  "type": "Example",
  "number": "4.3.5",
  "title": "",
...
},
{
  ...
  "number": "4.3.6",
  "title": "",
  "body": " Let's multiply . Since is the smaller number, we will write this on the left.    (for accessibility)    Now, we divide the left number by two. Since , we round down to and write this number below the left number. Also, we multiply the right number by two and write this below the right number.    (for accessibility)    We continue this process until we get to 1 on the left side. Note that so we round down to     (for accessibility)    Now, we cross out all rows that contain an even number on the left. That are the rows with the left number being and . This leaves the rows with the left number being and .    (for accessibility)    We now sum the right numbers of the remaining rows:     (for accessibility)    "
},
{
...
},
{
  ...
  "body": " Division Algorithms   Division Algorithms   In this section, we examine long division and related methods through the lens of place value and the partitive model of division. We also explore how the algorithm adapts across number bases and mental arithmetic contexts.    Describe and perform the long division algorithm using place value and partial quotients.  Interpret each step of long division using the partitive model and the Quotient Remainder Theorem.  Apply estimation strategies in long division when the divisor is greater than a single digit.  Adapt long division to other bases, including base twelve.  Compare long division with short division, identifying how partial remainders are managed differently.     In this section, we will predominantly talk about only one algorithm, commonly called long division. We will talk about a few other algorithms that are minor variations of the well known long division.    Long Division  Consider the division problem where The idea behind long division uses the partitive mode of division along with the idea of place value. Starting with the largest place value of the dividend , we group as many of those place into groups. Any of that place value remaining we ungroup into the next largest place value. A quick note: remember from the Quotient Remainder Theorem that remainders are always between and (inclusive) so we know each remainder in our calculation, which we will call a place remainder , must be within this range. Let's write the above as an algorithm:    Write the division with the dividend under the \"long division\" symbol, and the divisor directly to the left.    (for accessibility)      Starting with the largest place value in , group as many of that place as possible evenly into groups. Write the number in each group above the place value you are working with (we call this the partial quotient of the place). Note that you may have some of that place value remaining.    Subtract the number you were able to group from the total of that place value to determine your place remainder. Do this subtraction below the dividend.    If the current place value is the ones place, you have finished. The remaining ones are your for the calculation, and the number above the dividend is the . Otherwise, ungroup the place remainder into the next place value to the right and add these to the place to the right. Go to Step 2.    Let's do an example to see how this works.   Let's do the calculation . We write this using the long division symbol. We think of as the number of groups we are making (using the partitive model of division).    (for accessibility)    Starting with the hundreds place, we find that we can group at most one hundred evenly into each of our four groups. We note this in the quotient by putting a in the hundreds place. We have hundred remaining.    (for accessibility)    Now we \"ungroup\" our one hundred into 10 tens, giving us tens. We note this in our calculation by \"bringing down\" the tens in the dividend.    (for accessibility)    Now, we can evenly divide our tens so that are in each group, with tens remaining (since , or .) We write the in the tens place of the quotient, and we have tens remaining. We write this down in our calculation.    (for accessibility)    We \"ungroup\" the tens into ones giving us ones. We write this in our calculation.    (for accessibility)    Finally, we can divide our ones so that are in each group of . We write this in our quotient and since we have ones remaining. Since we are at the ones place we are finished our calculation, and thus . Each group of contains with ones unable to be grouped evenly.    (for accessibility)     It may be the case that our divisor is not a single digit. In these cases, we don't usually know our \" times tables\" but we can use our estimation and trial-and-error skills to determine the correct number of places in each group. Let's do a quick example to see this in action:   Let's do . Now, we don't know our times tables, so we are going to have to estimate. Let's write our calculation in the correct long division form, and note that we won't include the block representation here, but it is worth using this representation if we need some visual guidance:    (for accessibility)    Now, we know that we cannot group hundreds evenly among groups, so we ungroup these into tens, giving us tens in total. We know that is close to , so we can use multiples of as an estimation for the correct hundreds quotient. We know and , so let's see if we can put at most tens evenly in each of our groups: and , so is the correct partial quotient. Subtracting, we find that we have a remainder of .    (for accessibility)    Ungrouping these tens into ones gives us ones in total. Using a similar procedure to before, we find that and so our ones quotient is with a remainder of .    (for accessibility)    Thus we have calculated that .     Long Division Base Twelve  Just like our other algorithms, we can perform division in any base we like. Let's do an example in base twelve. For this section, all numbers will be in base twelve even without the subscript indicating so, though sometimes it will be included for clarity.   Let's do the base twelve division computation . Remember here that is our symbol for \"ten\". Our base twelve multiplication table will help a lot, so we include it here for easy reference:    (for accessibility)    We write down our dividend and divisor in the appropriate locations. Now we perform the algorithm. We start at the place (a long made of cubes) and ask \"if we have 5 of this place, how many can be evenly divided among ten groups.\" We do not have enough to put any in the groups, so we put a zero in the quotient above this place (however, we don't need to explicitly write it since we do not write whole numbers starting with a zero). We have grouped of this place, and have remaining.    (for accessibility)    Each of this place can be ungrouped to twelve (that is ) of the place to the right. So we ungroup these to have of the next place value, which is (that is, cubes). Similarly we ask \"if we have of this place, how many can be evenly divided among ten groups?\" Using our multiplication table we see that and thus the most we can put in our groups is cubes. Thus we have grouped and have cubes remaining.    (for accessibility)    We now ungroup these cubes into forty-eight, or squares and add these to the squares we originally have. Similarly, since and we know that we can evenly put squares in each of our groups, and we have squares remaining.    (for accessibility)    We ungroup these squares to make ninety-six (or ) longs. Adding our original longs we have longs. Similarly to the previous places, we know and so we can evenly put longs in each of our groups, and we have remaining.    (for accessibility)    Finally, we ungroup these longs to make ones. Adding our original ones we have ones in total. Since and we know that we can evenly put ones in each of our groups, and we have remaining. We have reached the ones place, so we are finished. Thus     (for accessibility)       Short Division  There is another, slightly more encapsulated method of doing division. Essentially it is the same as long division, except we do the subtractions in our head and put the partial remainders above the digit in the place to the right. This gets a bit cumbersome if we have a large divisor (even greater than a single digit divisor can get tricky unless you're very comfortable with mental arithmetic). However, it's great for single digit divisors. We call this short division .  Rather than explaining short division in any depth, doing our previous long division problem using short division, along with the preceding explanation, should be instructive enough.   Let's do the calculation using short division. We will simply show the calculation here, and this should be enough to understand once we're reminded that the \"carried\" numbers that appear are the partial remainders from long division.  INCLUDE PIC OF LONG AND SHORT DIVISION, CIRCLING THE COMMON REMAINDERS IN BOTH CALCULATIONS     "
},
{
  "id": "objectives-DivisionAlgorithms",
  "level": "2",
  "url": "sec-DivisionAlgorithms.html#objectives-DivisionAlgorithms",
  "type": "Objectives",
  "number": "4.4",
  "title": "Division Algorithms",
  "body": " Division Algorithms   In this section, we examine long division and related methods through the lens of place value and the partitive model of division. We also explore how the algorithm adapts across number bases and mental arithmetic contexts.    Describe and perform the long division algorithm using place value and partial quotients.  Interpret each step of long division using the partitive model and the Quotient Remainder Theorem.  Apply estimation strategies in long division when the divisor is greater than a single digit.  Adapt long division to other bases, including base twelve.  Compare long division with short division, identifying how partial remainders are managed differently.   "
},
{
...
},
{
  ...
  "number": "4.4.1",
  "title": "",
  "body": " Let's do the calculation . We write this using the long division symbol. We think of as the number of groups we are making (using the partitive model of division).    (for accessibility)    Starting with the hundreds place, we find that we can group at most one hundred evenly into each of our four groups. We note this in the quotient by putting a in the hundreds place. We have hundred remaining.    (for accessibility)    Now we \"ungroup\" our one hundred into 10 tens, giving us tens. We note this in our calculation by \"bringing down\" the tens in the dividend.    (for accessibility)    Now, we can evenly divide our tens so that are in each group, with tens remaining (since , or .) We write the in the tens place of the quotient, and we have tens remaining. We write this down in our calculation.    (for accessibility)    We \"ungroup\" the tens into ones giving us ones. We write this in our calculation.    (for accessibility)    Finally, we can divide our ones so that are in each group of . We write this in our quotient and since we have ones remaining. Since we are at the ones place we are finished our calculation, and thus . Each group of contains with ones unable to be grouped evenly.    (for accessibility)    "
},
{
...
},
{
  ...
  "number": "4.4.3",
  "title": "",
  "body": " Let's do the base twelve division computation . Remember here that is our symbol for \"ten\". Our base twelve multiplication table will help a lot, so we include it here for easy reference:    (for accessibility)    We write down our dividend and divisor in the appropriate locations. Now we perform the algorithm. We start at the place (a long made of cubes) and ask \"if we have 5 of this place, how many can be evenly divided among ten groups.\" We do not have enough to put any in the groups, so we put a zero in the quotient above this place (however, we don't need to explicitly write it since we do not write whole numbers starting with a zero). We have grouped of this place, and have remaining.    (for accessibility)    Each of this place can be ungrouped to twelve (that is ) of the place to the right. So we ungroup these to have of the next place value, which is (that is, cubes). Similarly we ask \"if we have of this place, how many can be evenly divided among ten groups?\" Using our multiplication table we see that and thus the most we can put in our groups is cubes. Thus we have grouped and have cubes remaining.    (for accessibility)    We now ungroup these cubes into forty-eight, or squares and add these to the squares we originally have. Similarly, since and we know that we can evenly put squares in each of our groups, and we have squares remaining.    (for accessibility)    We ungroup these squares to make ninety-six (or ) longs. Adding our original longs we have longs. Similarly to the previous places, we know and so we can evenly put longs in each of our groups, and we have remaining.    (for accessibility)    Finally, we ungroup these longs to make ones. Adding our original ones we have ones in total. Since and we know that we can evenly put ones in each of our groups, and we have remaining. We have reached the ones place, so we are finished. Thus     (for accessibility)    "
},
{
...
{
  "id": "ArithmeticAlgorithms-7",
  "level": "1",
  "url": "ArithmeticAlgorithms-7.html",
  "type": "Section",
  "number": "4.5",
  "title": "Supplementary Exercises",
  "body": " Supplementary Exercises   Addition Algorithms: Practice      Complete each sum using any method you like.             Construct an addition table for base four (digits ) up to and including .       Construct an addition table for base eight (digits ) up to and including .       Construct an addition table for base twelve (digits ) up to and including .       For each sum, draw a place-value picture (blocks or grouped dots) and compute the result, regrouping appropriately for the base.             Using the standard addition algorithm , add and regroup appropriately for the base.             Using the partial sums algorithm , add and regroup appropriately for the base.              Using the lattice addition algorithm , add and regroup appropriately for the base.              For each sum, decide which algorithm (standard, partial sums, or lattice) is most appropriate and compute the total.            Daniel is from Twelvesburg (base twelve). His friend is from Eightsville (base eight). Daniel counts benches in his area and his friend counts . Daniel says there are benches in total, while his friend says there are . Are either of them correct? Explain clearly which base each numeral is in and justify your conclusion.       In base ten, investigate the largest possible carry when adding many numbers in a single column.   When adding four addends, what is the largest carry from one column to the next?  Find the largest possible carry for 5, 6, and 7 addends. Describe any pattern you notice.  Does your pattern continue for more addends? If not, propose a corrected pattern.  How would this carry behavior change in other bases (e.g., base twelve)? Explain.        If you were teaching a child how to add, where would you start? Outline a short progression of practice problems (with numbers you choose) and say why each step prepares for the next.       Subtraction Algorithms: Practice      Using the standard subtraction algorithm , find each difference. Regroup appropriately for the stated base.              Using the partial difference algorithm , perform each subtraction. Regroup appropriately for the base.              Using the same change strategy (add the same amount to both numbers to make the subtraction easier), compute each difference. Regroup appropriately for the base.              Using the equal additions algorithm (adding a full base group to the subtrahend and minuend to avoid borrowing), perform each subtraction. Regroup appropriately for the base.              For each subtraction, choose the algorithm (standard, partial differences, same change, or equal additions) that you think is most efficient. Compute the result and briefly justify your choice.            Identify and explain the error(s) in each student’s subtraction setup (if any). Describe how to correct the work.                                 What if the number being subtracted is larger than the one you subtract from? Consider .   Compute .  Compute on a calculator. What do you notice? How could an algorithm produce the same result?  Let with . Express in terms of and explain why this helps.  Write clear steps for handling cases with a negative result, using your preferred subtraction algorithm.        Dave’s company mixes bases in its books. Human Resources reports dollars in expenses; Marketing reports dollars in expenses.   If revenue is , compute the profit (in base twelve). Show how you combined expenses from different bases.  Next year, expenses stay the same but revenue is . Dave claims the profit is (base twelve). Find the actual profit (state the base) and explain Dave’s error.        Multiplication Algorithms: Practice      Use exponent laws to simplify each product (same base: add exponents).            Evaluate using associativity and commutativity of multiplication.             Use the partial products method to evaluate.            Use the standard multiplication algorithm to evaluate.             Use the Russian multiplication (halving\/doubling, strike out even rows) algorithm.      (hint: group powers of two)        Briefly discuss: for what kinds of problems is each algorithm (partial products, standard, Russian) most convenient?       Create a multiplication table in base four (digits ) up to and including .       Create a multiplication table in base eight (digits ) up to and including .       Create a multiplication table in base twelve (digits ) up to and including .       Evaluate without converting bases (use your tables from the previous exercises).            Given the partial products from a standard-algorithm layout, determine the multiplicands.   Top row shows . The three partial products written beneath are , , and (shifted by place). What was the other factor?  Top row shows . The partial products include , , , , , , , , (each appropriately shifted). What was the other factor?  Top row shows . The partial products include , , , , , , , , . What was the other factor?        Identify and explain the error(s), if any, in each student product.   For , a student lists nine one-digit lines (4, 5, 9, 4, 5, 9, 8, 10, 18) and sums to get . What place-value mistake is being made?  For , a student treats as and forgets the trailing zero shift. Explain how place shifting should work and what the correct structure of partial products is.  For , the partial products mishandle multiples of and . Explain how to organize the computation so every tens\/hundreds place is accounted for correctly.  For , a neatly organized set of shifted partial products leads to the correct total. State why this layout is valid (identify the properties used).        Division Algorithms: Practice      Solve each using long division . Give quotient and remainder where appropriate.             Solve each using short division . Give quotient and remainder where appropriate.             Compute each quotient (use any method: long division, factor the divisor, or estimation plus correction). Report quotient and remainder.              Solve each division without converting to base ten . Work directly in the stated base (a multiplication table in that base may help). Give quotient and remainder in the same base.               Steve has cookies and wants to share them fairly among six friends (equal whole-number amounts).   How many whole cookies does each friend get, and how many are left over?  Consider instead sharing between two people. Decide if this is possible without carrying out the full division, and explain your test.  Is sharing cookies among three people possible without division? Explain your reasoning clearly (hint: examine a quick test using the digits).        Compute each expression. Show intermediate quotients (and remainders, if any) you use.              Arithmetic Algorithms: Deeper Explanations      Explain why the standard column addition algorithm is correct in base .   State precisely what a “carry” represents in base , and why its value is always an integer between and .  Justify that adding the units column and writing the remainder “mod ” with a carry of preserves the total value of the sum.  Connect the algorithm to expanded form (powers of ) showing equality of values before and after carrying.        Show that the partial sums algorithm always produces the same result as the standard algorithm.          Explain the same-change subtraction idea: replacing with .   Prove algebraically that the difference is unchanged.  Give a base-ten number line model and a base-eight blocks model to illustrate the invariant.  Discuss when same-change is especially helpful (e.g., making the subtrahend a round number such as ).        Equal additions (a.k.a. complements) avoids borrowing by adding a full base unit to both minuend and subtrahend in a column.   Explain why adding to one column of both numbers preserves the overall difference.  Describe the relationship between equal additions in base ten and the ’s complement method; generalize to base and ’s complements.  Give a worked example in base twelve and narrate each invariant you are using.        Connect three models of multiplication: area\/array, partial products, and the standard algorithm.   Using an area diagram, decompose and write the sum of four partial products.  Explain how the shifts in the standard algorithm correspond to multiplying by powers of .  Why does the order of writing partial products not affect the final sum? Name the properties used.        Lattice methods reorganize partial products. Explain why lattice addition or multiplication produces the same result as the standard algorithm.   Identify where each digit–digit product appears in the lattice and which place value it contributes to.  Explain the diagonal carries as “collecting equal powers of .”        Russian (peasant) multiplication repeatedly halves one factor and doubles the other, summing only rows with odd halves.   Explain why corresponds to the binary expansion of one factor.  Prove correctness by induction on the number of halving steps, or by writing in base two.  Give an example where this method is faster than the standard algorithm and an example where it is slower, and explain why.        Justify the long division algorithm in base .   State what each quotient digit represents and why choosing the largest digit that “fits” is a greedy but correct step.  Explain why the remainder at each stage is strictly smaller than the divisor (in base units), ensuring termination.  Relate the algorithm to writing the dividend as with at each truncated place.        Short division often tacitly factors the divisor or performs mental carries.   Explain how dividing by can be transformed into multiplying by and dividing by , and why place value makes this efficient.  Give an example where factoring the divisor into primes yields a faster mental computation than straight long division.        Compare carrying\/borrowing behavior across bases.   Give the maximum possible carry from a single column when adding  two-digit base- numbers (justify your bound in terms of and ).  Describe a subtraction example in base eight where equal additions substantially reduces the number of borrows compared to the standard method; explain why.        Different algorithms shine in different situations. For each scenario, choose an algorithm and justify:   Multiply .  Subtract .  Divide .  Multiply .        Two students present work:   Student A multiplies and writes partial products (digitwise) with no shifting. Identify the misconception and rewrite the computation correctly, explaining the role of place-value shifts.  Student B computes by “same-change” as and then subtracts to get . Is the method valid? If so, state the invariant and fix any arithmetic mistakes; if not, explain the flaw.        Provide a concise proof or explanation:   In any base , lattice multiplication is just the distributive law applied to expanded forms.  For integers, the remainder after division by is unique with .  Partial sums and partial differences are both instances of associativity (grouping by like place values).        Explain how to use estimation to catch algorithmic slips.   Give an upper and lower bound for using one-digit rounding, and explain how such bounds can reveal place-shift errors.  Give a bound check for that would flag a misplaced quotient digit.        In base twelve, outline how you would perform and justify the first quotient digit without converting to base ten. What comparisons are you making between base-twelve multiples of and the leading part of the dividend?      "
},
{
  "id": "addition-algorithm-problems-2-1",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-1",
  "type": "Exercise",
  "number": "4.5.1.1",
  "title": "",
  "body": "  Complete each sum using any method you like.         "
},
{
  "id": "addition-algorithm-problems-2-2",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-2",
  "type": "Exercise",
  "number": "4.5.1.2",
  "title": "",
  "body": "  Construct an addition table for base four (digits ) up to and including .   "
},
{
  "id": "addition-algorithm-problems-2-3",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-3",
  "type": "Exercise",
  "number": "4.5.1.3",
  "title": "",
  "body": "  Construct an addition table for base eight (digits ) up to and including .   "
},
{
  "id": "addition-algorithm-problems-2-4",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-4",
  "type": "Exercise",
  "number": "4.5.1.4",
  "title": "",
  "body": "  Construct an addition table for base twelve (digits ) up to and including .   "
},
{
  "id": "addition-algorithm-problems-2-5",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-5",
  "type": "Exercise",
  "number": "4.5.1.5",
  "title": "",
  "body": "  For each sum, draw a place-value picture (blocks or grouped dots) and compute the result, regrouping appropriately for the base.         "
},
{
  "id": "addition-algorithm-problems-2-6",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-6",
  "type": "Exercise",
  "number": "4.5.1.6",
  "title": "",
  "body": "  Using the standard addition algorithm , add and regroup appropriately for the base.         "
},
{
  "id": "addition-algorithm-problems-2-7",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-7",
  "type": "Exercise",
  "number": "4.5.1.7",
  "title": "",
  "body": "  Using the partial sums algorithm , add and regroup appropriately for the base.          "
},
{
  "id": "addition-algorithm-problems-2-8",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-8",
  "type": "Exercise",
  "number": "4.5.1.8",
  "title": "",
  "body": "  Using the lattice addition algorithm , add and regroup appropriately for the base.          "
},
{
  "id": "addition-algorithm-problems-2-9",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-9",
  "type": "Exercise",
  "number": "4.5.1.9",
  "title": "",
  "body": "  For each sum, decide which algorithm (standard, partial sums, or lattice) is most appropriate and compute the total.        "
},
{
  "id": "addition-algorithm-problems-2-10",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-10",
  "type": "Exercise",
  "number": "4.5.1.10",
  "title": "",
...
{
  "id": "addition-algorithm-problems-2-11",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-11",
  "type": "Exercise",
  "number": "4.5.1.11",
  "title": "",
  "body": "  In base ten, investigate the largest possible carry when adding many numbers in a single column.   When adding four addends, what is the largest carry from one column to the next?  Find the largest possible carry for 5, 6, and 7 addends. Describe any pattern you notice.  Does your pattern continue for more addends? If not, propose a corrected pattern.  How would this carry behavior change in other bases (e.g., base twelve)? Explain.    "
},
{
  "id": "addition-algorithm-problems-2-12",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#addition-algorithm-problems-2-12",
  "type": "Exercise",
  "number": "4.5.1.12",
  "title": "",
  "body": "  If you were teaching a child how to add, where would you start? Outline a short progression of practice problems (with numbers you choose) and say why each step prepares for the next.   "
},
{
  "id": "subtraction-algorithm-problems-2-1",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#subtraction-algorithm-problems-2-1",
  "type": "Exercise",
  "number": "4.5.2.1",
  "title": "",
  "body": "  Using the standard subtraction algorithm , find each difference. Regroup appropriately for the stated base.          "
},
{
  "id": "subtraction-algorithm-problems-2-2",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#subtraction-algorithm-problems-2-2",
  "type": "Exercise",
  "number": "4.5.2.2",
  "title": "",
  "body": "  Using the partial difference algorithm , perform each subtraction. Regroup appropriately for the base.          "
},
{
  "id": "subtraction-algorithm-problems-2-3",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#subtraction-algorithm-problems-2-3",
  "type": "Exercise",
  "number": "4.5.2.3",
  "title": "",
  "body": "  Using the same change strategy (add the same amount to both numbers to make the subtraction easier), compute each difference. Regroup appropriately for the base.          "
},
{
  "id": "subtraction-algorithm-problems-2-4",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#subtraction-algorithm-problems-2-4",
  "type": "Exercise",
  "number": "4.5.2.4",
  "title": "",
  "body": "  Using the equal additions algorithm (adding a full base group to the subtrahend and minuend to avoid borrowing), perform each subtraction. Regroup appropriately for the base.          "
},
{
  "id": "subtraction-algorithm-problems-2-5",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#subtraction-algorithm-problems-2-5",
  "type": "Exercise",
  "number": "4.5.2.5",
  "title": "",
  "body": "  For each subtraction, choose the algorithm (standard, partial differences, same change, or equal additions) that you think is most efficient. Compute the result and briefly justify your choice.        "
},
{
  "id": "subtraction-algorithm-problems-2-6",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#subtraction-algorithm-problems-2-6",
  "type": "Exercise",
  "number": "4.5.2.6",
  "title": "",
  "body": "  Identify and explain the error(s) in each student’s subtraction setup (if any). Describe how to correct the work.                             "
},
{
  "id": "subtraction-algorithm-problems-2-7",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#subtraction-algorithm-problems-2-7",
  "type": "Exercise",
  "number": "4.5.2.7",
  "title": "",
  "body": "  What if the number being subtracted is larger than the one you subtract from? Consider .   Compute .  Compute on a calculator. What do you notice? How could an algorithm produce the same result?  Let with . Express in terms of and explain why this helps.  Write clear steps for handling cases with a negative result, using your preferred subtraction algorithm.    "
},
{
  "id": "subtraction-algorithm-problems-2-8",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#subtraction-algorithm-problems-2-8",
  "type": "Exercise",
  "number": "4.5.2.8",
  "title": "",
  "body": "  Dave’s company mixes bases in its books. Human Resources reports dollars in expenses; Marketing reports dollars in expenses.   If revenue is , compute the profit (in base twelve). Show how you combined expenses from different bases.  Next year, expenses stay the same but revenue is . Dave claims the profit is (base twelve). Find the actual profit (state the base) and explain Dave’s error.    "
},
{
  "id": "multiplication-algorithm-problems-2-1",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-1",
  "type": "Exercise",
  "number": "4.5.3.1",
  "title": "",
  "body": "  Use exponent laws to simplify each product (same base: add exponents).        "
},
{
  "id": "multiplication-algorithm-problems-2-2",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-2",
  "type": "Exercise",
  "number": "4.5.3.2",
  "title": "",
  "body": "  Evaluate using associativity and commutativity of multiplication.         "
},
{
  "id": "multiplication-algorithm-problems-2-3",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-3",
  "type": "Exercise",
  "number": "4.5.3.3",
  "title": "",
  "body": "  Use the partial products method to evaluate.        "
},
{
  "id": "multiplication-algorithm-problems-2-4",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-4",
  "type": "Exercise",
  "number": "4.5.3.4",
  "title": "",
  "body": "  Use the standard multiplication algorithm to evaluate.         "
},
{
  "id": "multiplication-algorithm-problems-2-5",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-5",
  "type": "Exercise",
  "number": "4.5.3.5",
  "title": "",
  "body": "  Use the Russian multiplication (halving\/doubling, strike out even rows) algorithm.      (hint: group powers of two)    "
},
{
  "id": "multiplication-algorithm-problems-2-6",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-6",
  "type": "Exercise",
  "number": "4.5.3.6",
  "title": "",
  "body": "  Briefly discuss: for what kinds of problems is each algorithm (partial products, standard, Russian) most convenient?   "
},
{
  "id": "multiplication-algorithm-problems-2-7",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-7",
  "type": "Exercise",
  "number": "4.5.3.7",
  "title": "",
  "body": "  Create a multiplication table in base four (digits ) up to and including .   "
},
{
  "id": "multiplication-algorithm-problems-2-8",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-8",
  "type": "Exercise",
  "number": "4.5.3.8",
  "title": "",
  "body": "  Create a multiplication table in base eight (digits ) up to and including .   "
},
{
  "id": "multiplication-algorithm-problems-2-9",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-9",
  "type": "Exercise",
  "number": "4.5.3.9",
  "title": "",
  "body": "  Create a multiplication table in base twelve (digits ) up to and including .   "
},
{
  "id": "multiplication-algorithm-problems-2-10",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-10",
  "type": "Exercise",
  "number": "4.5.3.10",
  "title": "",
  "body": "  Evaluate without converting bases (use your tables from the previous exercises).        "
},
{
  "id": "multiplication-algorithm-problems-2-11",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-11",
  "type": "Exercise",
  "number": "4.5.3.11",
  "title": "",
  "body": "  Given the partial products from a standard-algorithm layout, determine the multiplicands.   Top row shows . The three partial products written beneath are , , and (shifted by place). What was the other factor?  Top row shows . The partial products include , , , , , , , , (each appropriately shifted). What was the other factor?  Top row shows . The partial products include , , , , , , , , . What was the other factor?    "
},
{
  "id": "multiplication-algorithm-problems-2-12",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#multiplication-algorithm-problems-2-12",
  "type": "Exercise",
  "number": "4.5.3.12",
  "title": "",
  "body": "  Identify and explain the error(s), if any, in each student product.   For , a student lists nine one-digit lines (4, 5, 9, 4, 5, 9, 8, 10, 18) and sums to get . What place-value mistake is being made?  For , a student treats as and forgets the trailing zero shift. Explain how place shifting should work and what the correct structure of partial products is.  For , the partial products mishandle multiples of and . Explain how to organize the computation so every tens\/hundreds place is accounted for correctly.  For , a neatly organized set of shifted partial products leads to the correct total. State why this layout is valid (identify the properties used).    "
},
{
  "id": "division-algorithm-problems-2-1",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#division-algorithm-problems-2-1",
  "type": "Exercise",
  "number": "4.5.4.1",
  "title": "",
  "body": "  Solve each using long division . Give quotient and remainder where appropriate.         "
},
{
  "id": "division-algorithm-problems-2-2",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#division-algorithm-problems-2-2",
  "type": "Exercise",
  "number": "4.5.4.2",
  "title": "",
  "body": "  Solve each using short division . Give quotient and remainder where appropriate.         "
},
{
  "id": "division-algorithm-problems-2-3",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#division-algorithm-problems-2-3",
  "type": "Exercise",
  "number": "4.5.4.3",
  "title": "",
  "body": "  Compute each quotient (use any method: long division, factor the divisor, or estimation plus correction). Report quotient and remainder.          "
},
{
  "id": "division-algorithm-problems-2-4",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#division-algorithm-problems-2-4",
  "type": "Exercise",
  "number": "4.5.4.4",
  "title": "",
  "body": "  Solve each division without converting to base ten . Work directly in the stated base (a multiplication table in that base may help). Give quotient and remainder in the same base.           "
},
{
  "id": "division-algorithm-problems-2-5",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#division-algorithm-problems-2-5",
  "type": "Exercise",
  "number": "4.5.4.5",
  "title": "",
  "body": "  Steve has cookies and wants to share them fairly among six friends (equal whole-number amounts).   How many whole cookies does each friend get, and how many are left over?  Consider instead sharing between two people. Decide if this is possible without carrying out the full division, and explain your test.  Is sharing cookies among three people possible without division? Explain your reasoning clearly (hint: examine a quick test using the digits).    "
},
{
  "id": "division-algorithm-problems-2-6",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#division-algorithm-problems-2-6",
  "type": "Exercise",
  "number": "4.5.4.6",
  "title": "",
  "body": "  Compute each expression. Show intermediate quotients (and remainders, if any) you use.          "
},
{
  "id": "arithmetic-algorithms-explanatory-2-1",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-1",
  "type": "Exercise",
  "number": "4.5.5.1",
  "title": "",
  "body": "  Explain why the standard column addition algorithm is correct in base .   State precisely what a “carry” represents in base , and why its value is always an integer between and .  Justify that adding the units column and writing the remainder “mod ” with a carry of preserves the total value of the sum.  Connect the algorithm to expanded form (powers of ) showing equality of values before and after carrying.    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-2",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-2",
  "type": "Exercise",
  "number": "4.5.5.2",
  "title": "",
  "body": "  Show that the partial sums algorithm always produces the same result as the standard algorithm.      "
},
{
  "id": "arithmetic-algorithms-explanatory-2-3",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-3",
  "type": "Exercise",
  "number": "4.5.5.3",
  "title": "",
  "body": "  Explain the same-change subtraction idea: replacing with .   Prove algebraically that the difference is unchanged.  Give a base-ten number line model and a base-eight blocks model to illustrate the invariant.  Discuss when same-change is especially helpful (e.g., making the subtrahend a round number such as ).    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-4",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-4",
  "type": "Exercise",
  "number": "4.5.5.4",
  "title": "",
  "body": "  Equal additions (a.k.a. complements) avoids borrowing by adding a full base unit to both minuend and subtrahend in a column.   Explain why adding to one column of both numbers preserves the overall difference.  Describe the relationship between equal additions in base ten and the ’s complement method; generalize to base and ’s complements.  Give a worked example in base twelve and narrate each invariant you are using.    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-5",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-5",
  "type": "Exercise",
  "number": "4.5.5.5",
  "title": "",
  "body": "  Connect three models of multiplication: area\/array, partial products, and the standard algorithm.   Using an area diagram, decompose and write the sum of four partial products.  Explain how the shifts in the standard algorithm correspond to multiplying by powers of .  Why does the order of writing partial products not affect the final sum? Name the properties used.    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-6",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-6",
  "type": "Exercise",
  "number": "4.5.5.6",
  "title": "",
  "body": "  Lattice methods reorganize partial products. Explain why lattice addition or multiplication produces the same result as the standard algorithm.   Identify where each digit–digit product appears in the lattice and which place value it contributes to.  Explain the diagonal carries as “collecting equal powers of .”    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-7",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-7",
  "type": "Exercise",
  "number": "4.5.5.7",
  "title": "",
  "body": "  Russian (peasant) multiplication repeatedly halves one factor and doubles the other, summing only rows with odd halves.   Explain why corresponds to the binary expansion of one factor.  Prove correctness by induction on the number of halving steps, or by writing in base two.  Give an example where this method is faster than the standard algorithm and an example where it is slower, and explain why.    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-8",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-8",
  "type": "Exercise",
  "number": "4.5.5.8",
  "title": "",
  "body": "  Justify the long division algorithm in base .   State what each quotient digit represents and why choosing the largest digit that “fits” is a greedy but correct step.  Explain why the remainder at each stage is strictly smaller than the divisor (in base units), ensuring termination.  Relate the algorithm to writing the dividend as with at each truncated place.    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-9",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-9",
  "type": "Exercise",
  "number": "4.5.5.9",
  "title": "",
  "body": "  Short division often tacitly factors the divisor or performs mental carries.   Explain how dividing by can be transformed into multiplying by and dividing by , and why place value makes this efficient.  Give an example where factoring the divisor into primes yields a faster mental computation than straight long division.    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-10",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-10",
  "type": "Exercise",
  "number": "4.5.5.10",
  "title": "",
  "body": "  Compare carrying\/borrowing behavior across bases.   Give the maximum possible carry from a single column when adding  two-digit base- numbers (justify your bound in terms of and ).  Describe a subtraction example in base eight where equal additions substantially reduces the number of borrows compared to the standard method; explain why.    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-11",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-11",
  "type": "Exercise",
  "number": "4.5.5.11",
  "title": "",
  "body": "  Different algorithms shine in different situations. For each scenario, choose an algorithm and justify:   Multiply .  Subtract .  Divide .  Multiply .    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-12",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-12",
  "type": "Exercise",
  "number": "4.5.5.12",
  "title": "",
  "body": "  Two students present work:   Student A multiplies and writes partial products (digitwise) with no shifting. Identify the misconception and rewrite the computation correctly, explaining the role of place-value shifts.  Student B computes by “same-change” as and then subtracts to get . Is the method valid? If so, state the invariant and fix any arithmetic mistakes; if not, explain the flaw.    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-13",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-13",
  "type": "Exercise",
  "number": "4.5.5.13",
  "title": "",
  "body": "  Provide a concise proof or explanation:   In any base , lattice multiplication is just the distributive law applied to expanded forms.  For integers, the remainder after division by is unique with .  Partial sums and partial differences are both instances of associativity (grouping by like place values).    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-14",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-14",
  "type": "Exercise",
  "number": "4.5.5.14",
  "title": "",
  "body": "  Explain how to use estimation to catch algorithmic slips.   Give an upper and lower bound for using one-digit rounding, and explain how such bounds can reveal place-shift errors.  Give a bound check for that would flag a misplaced quotient digit.    "
},
{
  "id": "arithmetic-algorithms-explanatory-2-15",
  "level": "2",
  "url": "ArithmeticAlgorithms-7.html#arithmetic-algorithms-explanatory-2-15",
  "type": "Exercise",
  "number": "4.5.5.15",
  "title": "",
  "body": "  In base twelve, outline how you would perform and justify the first quotient digit without converting to base ten. What comparisons are you making between base-twelve multiples of and the leading part of the dividend?   "
},
{
  "id": "Fractions-2",
  "level": "1",
...
},
{
  ...
  "number": "5.1.3",
  "title": "",
  "body": " Consider the fraction . This represents one part of a whole that is divided into two equal parts.    A diagram illustrating the fraction , where one part of the whole is shaded.     "
},
{
  ...
  "number": "5.1.5",
  "title": "",
  "body": " Now, consider the fraction . This represents three parts of a whole that is divided into four equal parts.   (For accessibility purposes)     "
},
{
  ...
  "number": "5.1.6",
  "title": "",
  "body": " Two fractions and are called equivalent fractions if . In other words, they represent the same quantity or part of a whole. In fact, you can see that we can take a fractional representation and either \"chop\" each piece into equal sized pieces, which corresponds to multiplying both the numerator and denominator by , or \"gluing\" equal pieces together to make a larger equal piece, which corresponds to dividing the numerator and denominator by . Note that in the second case, you need to be able to make equal groups of size , so this means that both the numerator and denominator must be divisible by .  "
},
{
  ...
  "number": "5.1.7",
  "title": "",
  "body": " Consider the fractions and . These fractions are equivalent because . Equivalently, since we can multiply each of and by to get and (or divide and by , conversely), you can see that these are equivalent fractions.   (For accessibility purposes)     "
},
{
...
},
{
  ...
  "body": " Comparing Fractions with Different Denominators  Let's compare the fractions and . Using the first method above, we need to find the LCD, which is the smallest multiple that both denominators (4 and 6) can divide into. In this case, the LCD is 12. So, using the notation above, and since   Now, we need to find equivalent fractions for and with a denominator of 12. We can do this by multiplying the numerator and denominator of each fraction by the same number, such that the denominator becomes 12:   So, is equivalent to and is equivalent to . Now, we can compare the numerators of these equivalent fractions: 9 is less than 10, so .  Alternatively, we could have used the second method and compared the fractions and and ended up with the same result.  "
},
{
  ...
  "body": " Comparing Three Fractions  Let's compare the following fractions: , , and . First, we need to find the least common denominator (LCD), which is the smallest multiple that all three denominators (3, 9, and 12) can divide into. In this case, the LCD is 36. So, we have , , and since .  Now, we need to find equivalent fractions for each fraction with a denominator of 36:   So, is equivalent to , the fraction is equivalent to , and is equivalent to . Comparing the numerators of these equivalent fractions, we have . Thus, the order of the fractions from smallest to largest is: .  "
},
{
...
},
{
  ...
  "body": " Lemma: Between Two Even Integers   Let be even integers such that . Then .   Before we prove this, let's talk about the idea. Since two even numbers differ by at least 2, we can take one more than the smallest even number, and that will be between both. Try and draw a diagram that clearly shows this.   Since is even we know that for some whole number . We also know the next largest even number is . Since is an even integer and then . Clearly and thus putting it all together,    "
},
{
  "id": "DensityOfFractions-11",
  "level": "2",
  "url": "Fractions-2.html#DensityOfFractions-11",
  "type": "Theorem",
  "number": "5.1.18",
...
},
{
  ...
  "number": "5.2.1",
  "title": "",
  "body": " Consider adding 3 apples and 5 apples. How many apples do you have? What about 3 pens and 5 pens. What about 3 eighths and 5 eighths? How many eighths do you have?  "
},
{
  "id": "AddingSubtractingFractions-5",
  "level": "2",
  "url": "Fractions-3.html#AddingSubtractingFractions-5",
  "type": "Example",
  "number": "5.2.2",
...
{
  "id": "AddingSubtractingFractions-7",
  "level": "2",
  "url": "Fractions-3.html#AddingSubtractingFractions-7",
  "type": "Example",
  "number": "5.2.3",
...
},
{
  "id": "MixedFractions-2",
  "level": "2",
  "url": "Fractions-3.html#MixedFractions-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "mixed fractions. improper fractions "
},
{
...
{
  "id": "ImproperToFractions-4",
  "level": "2",
  "url": "Fractions-3.html#ImproperToFractions-4",
  "type": "Example",
  "number": "5.2.9",
...
},
{
  ...
  "number": "5.2.10",
  "title": "",
  "body": "  What is , or in other words, half of 3?    If we take three units and split everything in half, we essentially have three halves, or .   "
},
{
...
},
{
  ...
  "number": "5.2.12",
  "title": "",
  "body": "  What is , or in other words, two-fifths of two-thirds?    If we take two thirds and divide them into fifths, and then take two of those fifths, we essentially have .   "
},
{
  "id": "def-Reciprocal",
  "level": "2",
  ...
  "number": "5.2.13",
  "title": "",
  "body": "  The reciprocal of a fraction , where and are both nonzero, is - essentially, we swap the numerator and the denominator.   "
},
{
  "id": "ex-Reciprocal",
  "level": "2",
  ...
  "number": "5.2.14",
  "title": "",
  "body": "  What is the reciprocal of ?    The reciprocal of is .   "
},
{
  "id": "subsec-MultiplicationOfFractions-10",
  "level": "2",
  "url": "Fractions-3.html#subsec-MultiplicationOfFractions-10",
  "type": "Checkpoint",
  "number": "5.2.15",
  "title": "",
  "body": "   Why does both the numerator and denominator have to be non-zero to meaningfully talk about a reciprocal?    "
},
{
  ...
  "body": " Adding, Subtracting, Multiplying, and Dividing Fractions   Let's perform multiple operations on fractions in one problem. Consider the expression:     To simplify the expression, we follow the order of operations (BEDMAS): Brackets, Exponents, Multiplication and Division (from left to right), Addition and Subtraction (from left to right).  First, we handle the division by changing the operation to multiplication by the reciprocal of the divisor:   Multiplying these fractions and reducing to equivalent fractions where possible:   So the original expression is equivalent to   We have dealt with all of the multiplication and division. Now we can add and subtract from left to right. Noting that and then having a common denominator of 36 we have   Thus, the simplified result of the given expression is .   "
},
{
...
},
{
  ...
  "body": " Proportional Reasoning   Introduction to Ratios, Proportions, and Rates   Learning Objectives   In this section, you will explore how ratios, rates, and proportions can be used to represent and solve a wide variety of mathematical and real-world problems.    Differentiate between ratios, rates, and proportions, and identify their appropriate contexts.  Simplify ratios and calculate unit rates from real-world data.  Set up and solve proportions using equivalent ratios or cross multiplication.  Use proportions to solve problems involving percentages, recipes, speed, grading, and scale.  Apply rate-based reasoning to combined work problems and other compound applications.    Ratios, proportions, and rates are ideas that connect numbers to the real world. They help us compare quantities, scale figures up or down, and describe how two measurements change together. For example, when we say that a recipe calls for cups of flour for every cups of sugar, we are describing a ratio . When we say that two such comparisons are equal, we are working with a proportion . And when we describe how one quantity changes compared to another with different units—such as kilometers per hour or dollars per item—we are describing a rate .  These ideas are important in many areas of mathematics and in everyday life. Students first meet them in elementary school when comparing objects (\"there are twice as many squares as circles\") or when learning about fractions. In middle school, they are used in scaling drawings, converting units, understanding percentages, and working with similar figures in geometry. Later, proportional reasoning becomes a foundation for algebra, functions, and modeling real-world problems.  Ratios, proportions, and rates also help us reason more flexibly about numbers. Instead of focusing only on exact counts, they let us focus on relationships between quantities. This relational thinking is central to mathematics: whether comparing sides of a triangle, predicting outcomes in probability, or interpreting slopes of lines in algebra, proportional reasoning is the bridge that connects different ideas.    Ratios  A ratio is a way of comparing two quantities. Ratios tell us how much of one thing there is compared to another. For example, we might compare the number of apples to the number of oranges in a basket, or the number of boys to the number of girls in a class. Ratios are often written in one of three ways: with a colon (e.g. ), with the word “to” (e.g. 3 to 4 ), or as a fraction (e.g. ).    Given two quantities and (with ), the ratio of to is written as , and expresses how many parts of there are for every part of . A ratio can also be represented as the fraction .     Here are some examples to illustrate the meaning of a ratio:    In a basket with apples and oranges, the ratio of apples to oranges is . We can simplify this ratio, just as we do with fractions, to . This means that for every 3 apples, there are 2 oranges.    If a class has 12 boys and 18 girls, the ratio of boys to girls is . Simplifying gives . We can interpret this as “for every 2 boys there are 3 girls.”    Ratios can also compare a part to the whole. If the same class has 12 boys and 18 girls (for a total of 30 students), then the ratio of boys to the whole class is , which simplifies to . This tells us that 2 out of every 5 students are boys.      Let’s look at a more involved real-world example. Suppose a drink mix calls for 2 cups of concentrate to be mixed with 5 cups of water. We want to make a large batch with 21 cups of water. How much concentrate is needed?  First, notice that the original recipe gives the ratio of concentrate to water as . That means for every 5 cups of water, we need 2 cups of concentrate.  To scale up, we can compare the known amount of water to the ratio:   Here, is the unknown number of cups of concentrate. Since these ratios must be equal, we can solve the equation using the property of equality:     Therefore, we need 8.4 cups of concentrate. In practical terms, this means about 8 and a half cups. Notice how the ratio guided us to scale up the recipe correctly.    Work with the following ratio problems. Simplify your answers when possible.    A recipe uses 9 cups of flour and 12 cups of sugar. What is the ratio of flour to sugar?    In a class of 28 students, 12 are left-handed. What is the ratio of left-handed to right-handed students?    A box contains 15 red marbles and 25 blue marbles. What is the ratio of red marbles to the total number of marbles?    A car travels 180 km on 12 liters of gas. What is the ratio of kilometers to liters?                     Just as fractions can be simplified or scaled up, ratios can also be rewritten in different but equivalent forms. If we have a ratio , then for any nonzero number we can multiply both parts of the ratio by and obtain . Since the fraction form of the ratio is , and   both and describe the same relationship between and . In the same way, dividing both parts of a ratio by a common factor gives a simpler equivalent ratio. This is why we often reduce ratios to their lowest terms, just as we do with fractions.  For example, the ratio can be simplified by dividing both terms by 2, giving . Both ratios represent the same relationship, because in each case the first quantity is one and a half times the second. The numbers may look different, but the comparison is unchanged.    Two ratios and are called equivalent ratios if they represent the same relationship between the two quantities. In particular, for any nonzero number , the ratios and are equivalent. Equivalently, and are equivalent exactly when   This is why simplifying a ratio by dividing both terms by their greatest common factor produces an equivalent ratio in lowest terms.    The ratio can be simplified by dividing both terms by 4, giving . Since , these ratios are equivalent.  Similarly, multiplying both terms of by 5 gives , which is also equivalent. All three ratios — , , and — describe the same relationship.      Part-to-Part and Part-to-Whole Comparisons  Ratios can be used in two different but related ways: to compare one part of a group to another part, or to compare one part of a group to the whole. These are called part-to-part and part-to-whole comparisons. Understanding the difference is important, since both are common in real-world situations.    - A part-to-part ratio compares one subset of a group to another subset. - A part-to-whole ratio compares one subset of a group to the entire group.     Suppose a basket contains 12 apples and 8 oranges, for a total of 20 pieces of fruit.    The ratio of apples to oranges is a part-to-part ratio: . This tells us that for every 3 apples there are 2 oranges.    The ratio of apples to the whole basket is a part-to-whole ratio: . This tells us that 3 out of every 5 fruits in the basket are apples.    Similarly, the ratio of oranges to the whole basket is . This means 2 out of every 5 fruits in the basket are oranges.      In a class of 30 students, 18 are girls and 12 are boys.   Part-to-part: the ratio of girls to boys is .  Part-to-whole: the ratio of girls to the class is , and the ratio of boys to the class is .   Notice that the two part-to-whole ratios always add up to 1 when written as fractions, because together they account for the entire group.    For each situation, write both a part-to-part and a part-to-whole ratio. Simplify when possible.    A bag contains 9 blue marbles and 6 green marbles.    A soccer team scored 15 goals in a season: 9 by forwards, 4 by midfielders, and 2 by defenders. Compare forwards to midfielders, and forwards to the whole team.    A survey of 50 people finds that 32 prefer tea and 18 prefer coffee.       Part-to-part: . Part-to-whole: , .    Part-to-part (forwards:midfielders): . Part-to-whole (forwards:total): .    Part-to-part (tea:coffee): . Part-to-whole: , .      Ratios are closely connected to fractions. A part-to-whole ratio can always be written directly as a fraction, because it compares one subset to the entire set. For example, if 12 of the 30 students in a class are boys, the ratio of boys to the whole class is , which corresponds to the fraction . This fraction can also be interpreted as “two-fifths of the class are boys.” A part-to-part ratio, on the other hand, can be turned into a fraction by placing one part over the other. For instance, if the same class has 12 boys and 18 girls, the part-to-part ratio is , or as a fraction , meaning that there are two boys for every three girls. In both cases, fractions and ratios capture the same idea of comparing quantities, but part-to-whole ratios align naturally with the notion of fractions of a whole, while part-to-part ratios highlight the relative size of two categories within the whole.   Notes for Additional Understanding  The close connection between ratios and fractions explains why proportional reasoning is such an important skill in mathematics. Part-to-whole ratios naturally lead to fractions of a whole, which in turn form the basis for understanding percentages, probabilities, and measures like slope in algebra. Part-to-part ratios can also be converted into fractions, and these comparisons are essential in statistics (for example, comparing groups within a population) and in geometry (for example, comparing the sides of similar triangles). Recognizing that ratios and fractions are two different ways of describing the same relationships helps students see mathematics as a connected whole rather than a collection of separate topics.     Proportions  A proportion is a statement that two ratios are equal. Proportions are especially useful because they allow us to find missing values when two quantities change in the same way. This is one of the most common uses of ratios in problem solving: scaling up or down while keeping the same relationship.    A proportion is an equation of the form where are numbers with and . If three of the numbers are known, the fourth can be found by solving the equation. This process is sometimes called “solving a proportion.”     Suppose we know that the ratio of cats to dogs in a shelter is 3:5. If there are 12 cats, how many dogs are there?  The ratio cats:dogs is . Writing this as a proportion with the known value:   Multiplying both sides by 5x (cross-multiplication):     So there are 20 dogs in the shelter.    A map uses a scale where 1 cm represents 25 km in real life. If two towns are 7 cm apart on the map, how far apart are they in reality?  The ratio of map distance to real distance is . Writing this as a proportion:   Cross-multiplying:    Therefore, the towns are 175 km apart.    In a recipe, 2 cups of sugar are used with 3 cups of flour. If you want to use 10 cups of flour, how much sugar should you use?     So you should use about 6 and 2\/3 cups of sugar.    Solve the following proportions. Give your answers in simplest form.             A school has the same student-to-teacher ratio in two grades. If one grade has 120 students and 6 teachers, how many teachers are needed for 200 students?                10 teachers      In the examples above we used cross multiplication to solve proportions. Let’s explain why this method works.  Suppose we have the proportion   with and . By the property of equality, we can multiply both sides of the equation by without changing the truth of the statement. Doing so gives:   Simplifying both sides:   or, written in the more familiar order,   This is exactly the rule of cross multiplication: in any true proportion, the product of the means equals the product of the extremes.  Let’s check this with numbers. Suppose   Cross multiplication says that . Both sides equal 30, so the proportion is indeed true.  This shows why cross multiplication is not just a “trick,” but a direct consequence of the properties of equality.    Proportional Reasoning in the School Curriculum  Proportional reasoning shows up throughout the school curriculum, often in ways that may not seem connected at first. Recognizing these connections helps students see mathematics as an integrated subject rather than as separate topics. Below we highlight some important areas where proportional reasoning is central, with explicit examples.   Changing Units:  Converting between measurement units always involves a proportion. For example, since , the ratio of meters to centimeters is . If a board is 2.4 meters long, we can set up a proportion:   Cross multiplying gives , so the board is 240 centimeters long.    Percentages:  Percentages are part-to-whole ratios out of 100. For instance, if 30 out of 50 students passed a test, then   Solving gives . Thus 60% of the students passed. Percentages are simply proportions where the denominator is fixed at 100.    Slope of a Line:  In algebra, the slope of a line is defined as the ratio of vertical change (“rise”) to horizontal change (“run”). For example, if a line passes through the points and , then the slope is   This tells us that for every 1 unit we move to the right, the line rises 2 units. Slope is therefore a constant ratio that describes the proportional relationship between changes in and .    Similar Figures in Geometry:  If two shapes are similar, their corresponding side lengths are proportional. For instance, suppose a small triangle has side lengths 3 cm, 4 cm, and 5 cm. A larger similar triangle has its shortest side equal to 9 cm. Since the scale factor is , the other sides must be cm and cm.    Probability:  Ratios are also at the heart of probability. If a bag contains 8 red marbles and 12 blue marbles, then the probability of drawing a red marble at random is the part-to-whole ratio   This means that on average, 2 out of every 5 draws will be red.   These examples show that proportional reasoning connects many topics that students study across grade levels. Whether converting units, interpreting percentages, graphing lines, working with similar figures, or calculating probabilities, the underlying structure is the same: one quantity changes in a constant ratio with another.   Solve the following problems, each showing a different use of proportional reasoning.    Unit Conversion: A rope is 3.5 meters long. How many centimeters is this?    Percentage: A student answered 18 questions correctly out of 24. What percentage did the student get correct?    Slope: Find the slope of the line passing through the points and .    Similar Figures: A rectangle has side lengths 4 cm by 6 cm. A similar rectangle has its shorter side equal to 10 cm. What is the longer side length?    Probability: A bag contains 5 green, 7 yellow, and 8 red candies. What is the probability of randomly selecting a yellow candy?       350 cm    75%       15 cm    or 35%        Final Grade via Proportional Reasoning: A student’s grade in a course is based on four components: assignments worth 20%, midterm 1 worth 20%, midterm 2 worth 20%, and a final exam worth 40%. Suppose the student earns 85% on assignments, 72% on midterm 1, 88% on midterm 2, and 91% on the final exam. What is the overall grade?  Each component contributes to the final grade in proportion to its weight. For example, assignments are worth 20% of the course, which is a part-to-whole ratio of . Within this 20% of the course, the student has earned 85% of the possible points. So the proportion   compares the contribution (in course percentage points) to the weight 20, just as the score compares to 100. Solving the proportion gives   Thus the student earns 17 percentage points from assignments.  We apply the same proportional reasoning to the other components. For midterm 1:   For midterm 2:   For the final exam, which has the greatest weight:   Finally, we add the proportional contributions together:   Therefore the student’s overall grade is 85.4%. Each step used a proportion: the student’s score out of 100 compared to their contribution out of the component’s weight. Summing these proportional parts gives the whole course grade. Here is a picture showing this.   Grade Proportion Diagram   Grade Proportion Diagram       "
},
{
  "id": "objectives-ratios-rates-proportions",
  "level": "2",
  "url": "Fractions-4.html#objectives-ratios-rates-proportions",
  "type": "Objectives",
  "number": "5.3.1",
  "title": "Learning Objectives",
  "body": " Learning Objectives   In this section, you will explore how ratios, rates, and proportions can be used to represent and solve a wide variety of mathematical and real-world problems.    Differentiate between ratios, rates, and proportions, and identify their appropriate contexts.  Simplify ratios and calculate unit rates from real-world data.  Set up and solve proportions using equivalent ratios or cross multiplication.  Use proportions to solve problems involving percentages, recipes, speed, grading, and scale.  Apply rate-based reasoning to combined work problems and other compound applications.   "
},
{
  "id": "subsec-RatioProportionIntro-3",
  "level": "2",
  "url": "Fractions-4.html#subsec-RatioProportionIntro-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "ratio proportion rate "
},
{
  "id": "def-Ratio",
  "level": "2",
  "url": "Fractions-4.html#def-Ratio",
  "type": "Definition",
  "number": "5.3.1",
  "title": "",
  "body": "  Given two quantities and (with ), the ratio of to is written as , and expresses how many parts of there are for every part of . A ratio can also be represented as the fraction .   "
},
{
  "id": "subsec-Ratios-4",
  "level": "2",
  "url": "Fractions-4.html#subsec-Ratios-4",
  "type": "Example",
  "number": "5.3.2",
  "title": "",
  "body": " Here are some examples to illustrate the meaning of a ratio:    In a basket with apples and oranges, the ratio of apples to oranges is . We can simplify this ratio, just as we do with fractions, to . This means that for every 3 apples, there are 2 oranges.    If a class has 12 boys and 18 girls, the ratio of boys to girls is . Simplifying gives . We can interpret this as “for every 2 boys there are 3 girls.”    Ratios can also compare a part to the whole. If the same class has 12 boys and 18 girls (for a total of 30 students), then the ratio of boys to the whole class is , which simplifies to . This tells us that 2 out of every 5 students are boys.    "
},
{
  "id": "subsec-Ratios-5",
  "level": "2",
  "url": "Fractions-4.html#subsec-Ratios-5",
  "type": "Example",
  "number": "5.3.3",
  "title": "",
  "body": " Let’s look at a more involved real-world example. Suppose a drink mix calls for 2 cups of concentrate to be mixed with 5 cups of water. We want to make a large batch with 21 cups of water. How much concentrate is needed?  First, notice that the original recipe gives the ratio of concentrate to water as . That means for every 5 cups of water, we need 2 cups of concentrate.  To scale up, we can compare the known amount of water to the ratio:   Here, is the unknown number of cups of concentrate. Since these ratios must be equal, we can solve the equation using the property of equality:     Therefore, we need 8.4 cups of concentrate. In practical terms, this means about 8 and a half cups. Notice how the ratio guided us to scale up the recipe correctly.  "
},
{
  "id": "subsec-Ratios-6",
  "level": "2",
  "url": "Fractions-4.html#subsec-Ratios-6",
  "type": "Checkpoint",
  "number": "5.3.4",
  "title": "",
  "body": " Work with the following ratio problems. Simplify your answers when possible.    A recipe uses 9 cups of flour and 12 cups of sugar. What is the ratio of flour to sugar?    In a class of 28 students, 12 are left-handed. What is the ratio of left-handed to right-handed students?    A box contains 15 red marbles and 25 blue marbles. What is the ratio of red marbles to the total number of marbles?    A car travels 180 km on 12 liters of gas. What is the ratio of kilometers to liters?                    "
},
{
  "id": "def-EquivalentRatios",
  "level": "2",
  "url": "Fractions-4.html#def-EquivalentRatios",
  "type": "Definition",
  "number": "5.3.5",
  "title": "",
  "body": "  Two ratios and are called equivalent ratios if they represent the same relationship between the two quantities. In particular, for any nonzero number , the ratios and are equivalent. Equivalently, and are equivalent exactly when   This is why simplifying a ratio by dividing both terms by their greatest common factor produces an equivalent ratio in lowest terms.    The ratio can be simplified by dividing both terms by 4, giving . Since , these ratios are equivalent.  Similarly, multiplying both terms of by 5 gives , which is also equivalent. All three ratios — , , and — describe the same relationship.   "
},
{
  "id": "subsec-PartComparisons-2",
  "level": "2",
  "url": "Fractions-4.html#subsec-PartComparisons-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "part-to-part part-to-whole "
},
{
  "id": "def-PartRatios",
  "level": "2",
  "url": "Fractions-4.html#def-PartRatios",
  "type": "Definition",
  "number": "5.3.7",
  "title": "",
  "body": "  - A part-to-part ratio compares one subset of a group to another subset. - A part-to-whole ratio compares one subset of a group to the entire group.   "
},
{
  "id": "subsec-PartComparisons-4",
  "level": "2",
  "url": "Fractions-4.html#subsec-PartComparisons-4",
  "type": "Example",
  "number": "5.3.8",
  "title": "",
  "body": " Suppose a basket contains 12 apples and 8 oranges, for a total of 20 pieces of fruit.    The ratio of apples to oranges is a part-to-part ratio: . This tells us that for every 3 apples there are 2 oranges.    The ratio of apples to the whole basket is a part-to-whole ratio: . This tells us that 3 out of every 5 fruits in the basket are apples.    Similarly, the ratio of oranges to the whole basket is . This means 2 out of every 5 fruits in the basket are oranges.    "
},
{
  "id": "subsec-PartComparisons-5",
  "level": "2",
  "url": "Fractions-4.html#subsec-PartComparisons-5",
  "type": "Example",
  "number": "5.3.9",
  "title": "",
  "body": " In a class of 30 students, 18 are girls and 12 are boys.   Part-to-part: the ratio of girls to boys is .  Part-to-whole: the ratio of girls to the class is , and the ratio of boys to the class is .   Notice that the two part-to-whole ratios always add up to 1 when written as fractions, because together they account for the entire group.  "
},
{
  "id": "subsec-PartComparisons-6",
  "level": "2",
  "url": "Fractions-4.html#subsec-PartComparisons-6",
  "type": "Checkpoint",
  "number": "5.3.10",
  "title": "",
  "body": " For each situation, write both a part-to-part and a part-to-whole ratio. Simplify when possible.    A bag contains 9 blue marbles and 6 green marbles.    A soccer team scored 15 goals in a season: 9 by forwards, 4 by midfielders, and 2 by defenders. Compare forwards to midfielders, and forwards to the whole team.    A survey of 50 people finds that 32 prefer tea and 18 prefer coffee.       Part-to-part: . Part-to-whole: , .    Part-to-part (forwards:midfielders): . Part-to-whole (forwards:total): .    Part-to-part (tea:coffee): . Part-to-whole: , .     "
},
{
  "id": "def-Proportion",
  "level": "2",
  "url": "Fractions-4.html#def-Proportion",
  "type": "Definition",
  "number": "5.3.11",
  "title": "",
  "body": "  A proportion is an equation of the form where are numbers with and . If three of the numbers are known, the fourth can be found by solving the equation. This process is sometimes called “solving a proportion.”   "
},
{
  "id": "subsec-Proportions-4",
  "level": "2",
  "url": "Fractions-4.html#subsec-Proportions-4",
  "type": "Example",
  "number": "5.3.12",
  "title": "",
  "body": " Suppose we know that the ratio of cats to dogs in a shelter is 3:5. If there are 12 cats, how many dogs are there?  The ratio cats:dogs is . Writing this as a proportion with the known value:   Multiplying both sides by 5x (cross-multiplication):     So there are 20 dogs in the shelter.  "
},
{
  "id": "subsec-Proportions-5",
  "level": "2",
  "url": "Fractions-4.html#subsec-Proportions-5",
  "type": "Example",
  "number": "5.3.13",
  "title": "",
  "body": " A map uses a scale where 1 cm represents 25 km in real life. If two towns are 7 cm apart on the map, how far apart are they in reality?  The ratio of map distance to real distance is . Writing this as a proportion:   Cross-multiplying:    Therefore, the towns are 175 km apart.  "
},
{
  "id": "subsec-Proportions-6",
  "level": "2",
  "url": "Fractions-4.html#subsec-Proportions-6",
  "type": "Example",
  "number": "5.3.14",
  "title": "",
  "body": " In a recipe, 2 cups of sugar are used with 3 cups of flour. If you want to use 10 cups of flour, how much sugar should you use?     So you should use about 6 and 2\/3 cups of sugar.  "
},
{
  "id": "subsec-Proportions-7",
  "level": "2",
  "url": "Fractions-4.html#subsec-Proportions-7",
  "type": "Checkpoint",
  "number": "5.3.15",
  "title": "",
  "body": " Solve the following proportions. Give your answers in simplest form.             A school has the same student-to-teacher ratio in two grades. If one grade has 120 students and 6 teachers, how many teachers are needed for 200 students?                10 teachers     "
},
{
  "id": "subsec-Proportions-8",
  "level": "2",
  "url": "Fractions-4.html#subsec-Proportions-8",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "cross multiplication "
},
{
  "id": "subsec-ProportionalReasoningCurriculum-3",
  "level": "2",
  "url": "Fractions-4.html#subsec-ProportionalReasoningCurriculum-3",
  "type": "Example",
  "number": "5.3.16",
  "title": "",
  "body": " Changing Units:  Converting between measurement units always involves a proportion. For example, since , the ratio of meters to centimeters is . If a board is 2.4 meters long, we can set up a proportion:   Cross multiplying gives , so the board is 240 centimeters long.  "
},
{
  "id": "subsec-ProportionalReasoningCurriculum-4",
  "level": "2",
  "url": "Fractions-4.html#subsec-ProportionalReasoningCurriculum-4",
  "type": "Example",
  "number": "5.3.17",
  "title": "",
  "body": " Percentages:  Percentages are part-to-whole ratios out of 100. For instance, if 30 out of 50 students passed a test, then   Solving gives . Thus 60% of the students passed. Percentages are simply proportions where the denominator is fixed at 100.  "
},
{
  "id": "subsec-ProportionalReasoningCurriculum-5",
  "level": "2",
  "url": "Fractions-4.html#subsec-ProportionalReasoningCurriculum-5",
  "type": "Example",
  "number": "5.3.18",
  "title": "",
  "body": " Slope of a Line:  In algebra, the slope of a line is defined as the ratio of vertical change (“rise”) to horizontal change (“run”). For example, if a line passes through the points and , then the slope is   This tells us that for every 1 unit we move to the right, the line rises 2 units. Slope is therefore a constant ratio that describes the proportional relationship between changes in and .  "
},
{
  "id": "subsec-ProportionalReasoningCurriculum-6",
  "level": "2",
  "url": "Fractions-4.html#subsec-ProportionalReasoningCurriculum-6",
  "type": "Example",
  "number": "5.3.19",
  "title": "",
  "body": " Similar Figures in Geometry:  If two shapes are similar, their corresponding side lengths are proportional. For instance, suppose a small triangle has side lengths 3 cm, 4 cm, and 5 cm. A larger similar triangle has its shortest side equal to 9 cm. Since the scale factor is , the other sides must be cm and cm.  "
},
{
  "id": "subsec-ProportionalReasoningCurriculum-7",
  "level": "2",
  "url": "Fractions-4.html#subsec-ProportionalReasoningCurriculum-7",
  "type": "Example",
  "number": "5.3.20",
  "title": "",
  "body": " Probability:  Ratios are also at the heart of probability. If a bag contains 8 red marbles and 12 blue marbles, then the probability of drawing a red marble at random is the part-to-whole ratio   This means that on average, 2 out of every 5 draws will be red.  "
},
{
  "id": "subsec-ProportionalReasoningCurriculum-9",
  "level": "2",
  "url": "Fractions-4.html#subsec-ProportionalReasoningCurriculum-9",
  "type": "Checkpoint",
  "number": "5.3.21",
  "title": "",
  "body": " Solve the following problems, each showing a different use of proportional reasoning.    Unit Conversion: A rope is 3.5 meters long. How many centimeters is this?    Percentage: A student answered 18 questions correctly out of 24. What percentage did the student get correct?    Slope: Find the slope of the line passing through the points and .    Similar Figures: A rectangle has side lengths 4 cm by 6 cm. A similar rectangle has its shorter side equal to 10 cm. What is the longer side length?    Probability: A bag contains 5 green, 7 yellow, and 8 red candies. What is the probability of randomly selecting a yellow candy?       350 cm    75%       15 cm    or 35%     "
},
{
  "id": "subsec-ProportionalReasoningCurriculum-10",
  "level": "2",
  "url": "Fractions-4.html#subsec-ProportionalReasoningCurriculum-10",
  "type": "Example",
  "number": "5.3.22",
  "title": "",
  "body": "  Final Grade via Proportional Reasoning: A student’s grade in a course is based on four components: assignments worth 20%, midterm 1 worth 20%, midterm 2 worth 20%, and a final exam worth 40%. Suppose the student earns 85% on assignments, 72% on midterm 1, 88% on midterm 2, and 91% on the final exam. What is the overall grade?  Each component contributes to the final grade in proportion to its weight. For example, assignments are worth 20% of the course, which is a part-to-whole ratio of . Within this 20% of the course, the student has earned 85% of the possible points. So the proportion   compares the contribution (in course percentage points) to the weight 20, just as the score compares to 100. Solving the proportion gives   Thus the student earns 17 percentage points from assignments.  We apply the same proportional reasoning to the other components. For midterm 1:   For midterm 2:   For the final exam, which has the greatest weight:   Finally, we add the proportional contributions together:   Therefore the student’s overall grade is 85.4%. Each step used a proportion: the student’s score out of 100 compared to their contribution out of the component’s weight. Summing these proportional parts gives the whole course grade. Here is a picture showing this.   Grade Proportion Diagram   Grade Proportion Diagram    "
},
{
  "id": "Fractions-5",
  "level": "1",
  "url": "Fractions-5.html",
  "type": "Section",
  "number": "5.4",
  "title": "Supplementary Exercises",
  "body": " Supplementary Exercises   Practice: Fractions Across Bases     Determine whether each pair (or triple) of fractions is equivalent.   and  and  and  , , and       Insert the correct symbol , , or to make each statement true.            Find a fraction whose value lies strictly between the given pair.   and  and  and  and       Julian and Frank share a watermelon. Frank asks for of the whole. Julian gives of the whole. Did Julian give the correct amount? Explain.      Find four distinct fractions strictly between and .      In base twelve (with , ), find four distinct fractions strictly between and .       Practice: Arithmetic with Fractions     Solve each subtraction. Express answers in lowest terms.            Solve each addition. Express answers in lowest terms.            Compute each expression. Express answers in lowest terms.            Convert each improper fraction to a mixed number (in lowest terms).            Convert each mixed number to an improper fraction (in lowest terms).            Daniel and Lupita each have leftover slices from their own large pizzas. Daniel has 4 of 8 slices; Lupita has 3 of 5 slices.   Who has more pizza?  Will all their slices fit into one pizza box if slices cannot be stacked? Justify.       Compute each product. Reduce answers to lowest terms; write improper results as mixed numbers.            Compute each quotient. Reduce answers to lowest terms; write improper results as mixed numbers.            Simplify each expression. Follow order of operations and reduce to lowest terms.            Daniel now has 8 of 12 slices, and Lupita has 4 of 6 slices. They invite two friends to share.   Can the four people share equally without cutting any slices? If not, what is the smallest number of cuts needed? Explain.  Would it be possible without cuts if Lupita had one more slice? If not, how many cuts would be needed?  With the amounts from Exercise 6 (4 of 8 and 3 of 5), can they share equally with exactly three cuts? Explain your strategy.  Describe a different scenario (choose slice counts, original partitions, number of friends) where they can share equally with exactly one cut. Explain.       Identify and explain the error(s) in each computation, then correct the result.                  Practice: Ratios, Rates, and Proportions     Simplify each ratio.            Classify each situation as a ratio , rate , or proportion , and write it accordingly.   There are 3 green marbles for every 4 blue marbles in the bag.  We have 20 marshmallows so we know there are 10 graham crackers.  grams of rice costs dollars.  In a bucket of gravel, there are 15 granite rocks per 7 basalt rocks.       Determine whether each rate can be expressed as a unit rate (per 1). If not, simplify as far as possible. You may use decimals for unit rates.            Form a proportion from each description and solve for the unknown. Simplify where appropriate.    There are 3 brown bears for every 1 black bear in the zoo. There are 7 black bears. How many brown bears?  Every shelf has 7 photos. There are 21 photos. How many shelves?       Create your own scenario described by a ratio between two quantities, and specify a numerical request that is impossible because of that ratio. Explain why it is impossible.      The ratio of blue to green gumballs in a surprise bag is .   If there are 16 blue gumballs, how many green gumballs are there?  A bag has 24 blue and 35 green gumballs. Is this consistent with the stated ratio? Explain.  Is it possible to have exactly 12 blue gumballs in a bag? Explain.  Is it possible to have exactly 6 blue gumballs in a bag? Explain.       Mike drives at a speed of .   Is Mike’s speed a ratio, a rate, or a proportion?  He arrives after 3 hours. What distance did he travel?  Mike’s friend claims Mike traveled 20 km. Describe the setup error that leads to this conclusion.       Pious is building a rectangular sheep pen with perimeter .   Store A (Bucket O’ Hammers) sells of fencing for . Store B (Screws, Nails and Everything Lumber) sells for . Pious doesn’t mind leftovers—he wants the best value. Which store should he choose?  How much will the fence cost at the chosen store?  If Pious wants to minimize leftover fencing instead, does the choice change? What is the cost now?  Suppose instead he wants a rectangular pen of area . What is the minimum fencing required, and which store yields the lowest cost?  Describe the general relationship between the target perimeter and the better store choice, considering potential leftovers.       Ronald played basketball games with the following results.   On Tuesday he played 3 games, scoring 5, 3, and 7 baskets. What was his overall rate (baskets per game) as a unit rate?  On Wednesday his average was . If he scored 45 baskets in total, how many games did he play?  The next day his overall rate was over 4 games. He scored 7, 8, and 12 in three of them. How many in the fourth?  Is it possible for Ronald to have 30 total baskets with a rate of ? Explain.       The payroll administrator at Bland Media Conglomerate LLC. reports wages and earnings in base twelve, while hours remain in base ten. Do not convert to base ten; work directly in the indicated bases.   After working 35 hours at , Julie received . Was there an error? What should she have been paid?  Greg worked 40 regular hours and 10 overtime hours. Overtime is paid at twice his regular wage. He was paid . What is his hourly rate (in base twelve)?  Jerry was paid . A fraction of his hours were at regular pay and the remaining were overtime. What is Jerry’s hourly wage (in base twelve)?  How many hours did Jerry work?        Explanatory Questions: Fractions     Fractions can mean different things in different contexts (part–whole, quotient, ratio, operator, measure). For each meaning, give a short real-world example for and explain why that meaning fits.      Two students claim that and are equivalent.   Explain why this is true by describing a visual model (area or number-line) in words.  Explain why this is true using a numerical argument about common factors and why your argument works in any base, not just base ten.       A student says: “Since and both have even numerators and denominators, because and .” Critique this reasoning carefully. Give a correct method to compare and and explain why it works.      (Mediant reasoning) Suppose and are positive fractions with . Explain why the fraction lies strictly between them. State any conditions you use (e.g., positivity) and justify in words and\/or symbols.      Explain why there are infinitely many fractions between and . Give a method that generates different examples on demand and explain why it always stays in the interval.      (Base-independence) A rule of simplification says: if , then . Explain why this statement is true regardless of the base used to write the digits of . Your explanation should separate “the quantities” from “their written representations.”      Error check: A learner writes     Identify the exact step where a property is misused. Then show two correct explanations for adding these fractions: (i) common denominator, (ii) visual model (describe the picture you would draw).      Explain why the rule “to convert a mixed number to an improper fraction, multiply the whole number by the denominator and add the numerator” is correct. Your explanation should work for an arbitrary , and may use a diagram or algebraic reasoning.      Multiplying fractions: Without doing any simplification first, explain why using an area model. Describe clearly how each factor is represented and why the overlapping region has the stated fraction of the whole.      Dividing by a fraction: Explain, using a measurement or sharing interpretation, why . Your explanation should make it clear why “multiply by the reciprocal” matches the story.      Cross-multiplication for comparison: To decide whether is greater than , one method forms and . Explain why this method is valid and how it relates to rewriting both fractions with a common denominator without actually finding the common denominator first.      (Betweeness via common denominators) Explain why, once two positive fractions are expressed with a common positive denominator, the one with the larger numerator is the larger fraction. Include a number-line interpretation that works even when the denominators are large.      (Fractions across bases) Explain why the statement is correct without converting any numbers into base ten. Describe the quantities each numeral represents in base four and how the equality follows from those quantities.      Least common denominator (LCD): A student always chooses the product of denominators as the common denominator. Explain when this is unnecessarily large, how to find a smaller LCD using prime factors, and why using the LCD can make computation and simplification clearer.      (Equivalent-fraction generation) Give a principled way to generate all fractions equivalent to . Explain why every fraction produced by your method is equivalent, and why any equivalent fraction must arise from your method.      (Order of operations with fractions) Consider . Explain two correct solution paths—one emphasizing order of operations first, and one rewriting everything over a common denominator—and justify why both lead to the same result.      (Reason about size) Without computing exact values, determine whether each expression is less than, equal to, or greater than , and explain your reasoning.           (Complex fractions) Explain a clear strategy for simplifying that avoids arithmetic mistakes. Justify why your strategy works and describe how you would check your final answer for reasonableness.      "
},
{
  "id": "intro-fractions-exercises-2-1",
  "level": "2",
  "url": "Fractions-5.html#intro-fractions-exercises-2-1",
  "type": "Exercise",
  "number": "5.4.1.1",
  "title": "",
  "body": "  Determine whether each pair (or triple) of fractions is equivalent.   and  and  and  , , and    "
},
{
  "id": "intro-fractions-exercises-2-2",
  "level": "2",
  "url": "Fractions-5.html#intro-fractions-exercises-2-2",
  "type": "Exercise",
  "number": "5.4.1.2",
  "title": "",
  "body": "  Insert the correct symbol , , or to make each statement true.         "
},
{
  "id": "intro-fractions-exercises-2-3",
  "level": "2",
  "url": "Fractions-5.html#intro-fractions-exercises-2-3",
  "type": "Exercise",
  "number": "5.4.1.3",
  "title": "",
  "body": "  Find a fraction whose value lies strictly between the given pair.   and  and  and  and    "
},
{
  "id": "intro-fractions-exercises-2-4",
  "level": "2",
  "url": "Fractions-5.html#intro-fractions-exercises-2-4",
  "type": "Exercise",
  "number": "5.4.1.4",
  "title": "",
  "body": "  Julian and Frank share a watermelon. Frank asks for of the whole. Julian gives of the whole. Did Julian give the correct amount? Explain.   "
},
{
  "id": "intro-fractions-exercises-2-5",
  "level": "2",
  "url": "Fractions-5.html#intro-fractions-exercises-2-5",
  "type": "Exercise",
  "number": "5.4.1.5",
  "title": "",
  "body": "  Find four distinct fractions strictly between and .   "
},
{
  "id": "intro-fractions-exercises-2-6",
  "level": "2",
  "url": "Fractions-5.html#intro-fractions-exercises-2-6",
  "type": "Exercise",
  "number": "5.4.1.6",
  "title": "",
  "body": "  In base twelve (with , ), find four distinct fractions strictly between and .   "
},
{
  "id": "arithmetic-with-fractions-exercises-2-1",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-1",
  "type": "Exercise",
  "number": "5.4.2.1",
  "title": "",
  "body": "  Solve each subtraction. Express answers in lowest terms.         "
},
{
  "id": "arithmetic-with-fractions-exercises-2-2",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-2",
  "type": "Exercise",
  "number": "5.4.2.2",
  "title": "",
  "body": "  Solve each addition. Express answers in lowest terms.         "
},
{
  "id": "arithmetic-with-fractions-exercises-2-3",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-3",
  "type": "Exercise",
  "number": "5.4.2.3",
  "title": "",
  "body": "  Compute each expression. Express answers in lowest terms.         "
},
{
  "id": "arithmetic-with-fractions-exercises-2-4",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-4",
  "type": "Exercise",
  "number": "5.4.2.4",
  "title": "",
  "body": "  Convert each improper fraction to a mixed number (in lowest terms).         "
},
{
  "id": "arithmetic-with-fractions-exercises-2-5",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-5",
  "type": "Exercise",
  "number": "5.4.2.5",
  "title": "",
  "body": "  Convert each mixed number to an improper fraction (in lowest terms).         "
},
{
  "id": "arithmetic-with-fractions-exercises-2-6",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-6",
  "type": "Exercise",
  "number": "5.4.2.6",
  "title": "",
  "body": "  Daniel and Lupita each have leftover slices from their own large pizzas. Daniel has 4 of 8 slices; Lupita has 3 of 5 slices.   Who has more pizza?  Will all their slices fit into one pizza box if slices cannot be stacked? Justify.    "
},
{
  "id": "arithmetic-with-fractions-exercises-2-7",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-7",
  "type": "Exercise",
  "number": "5.4.2.7",
  "title": "",
  "body": "  Compute each product. Reduce answers to lowest terms; write improper results as mixed numbers.         "
},
{
  "id": "arithmetic-with-fractions-exercises-2-8",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-8",
  "type": "Exercise",
  "number": "5.4.2.8",
  "title": "",
  "body": "  Compute each quotient. Reduce answers to lowest terms; write improper results as mixed numbers.         "
},
{
  "id": "arithmetic-with-fractions-exercises-2-9",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-9",
  "type": "Exercise",
  "number": "5.4.2.9",
  "title": "",
  "body": "  Simplify each expression. Follow order of operations and reduce to lowest terms.         "
},
{
  "id": "arithmetic-with-fractions-exercises-2-10",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-10",
  "type": "Exercise",
  "number": "5.4.2.10",
  "title": "",
  "body": "  Daniel now has 8 of 12 slices, and Lupita has 4 of 6 slices. They invite two friends to share.   Can the four people share equally without cutting any slices? If not, what is the smallest number of cuts needed? Explain.  Would it be possible without cuts if Lupita had one more slice? If not, how many cuts would be needed?  With the amounts from Exercise 6 (4 of 8 and 3 of 5), can they share equally with exactly three cuts? Explain your strategy.  Describe a different scenario (choose slice counts, original partitions, number of friends) where they can share equally with exactly one cut. Explain.    "
},
{
  "id": "arithmetic-with-fractions-exercises-2-11",
  "level": "2",
  "url": "Fractions-5.html#arithmetic-with-fractions-exercises-2-11",
  "type": "Exercise",
  "number": "5.4.2.11",
  "title": "",
  "body": "  Identify and explain the error(s) in each computation, then correct the result.              "
},
{
  "id": "ratios-rates-proportions-exercises-2-1",
  "level": "2",
  "url": "Fractions-5.html#ratios-rates-proportions-exercises-2-1",
  "type": "Exercise",
  "number": "5.4.3.1",
  "title": "",
  "body": "  Simplify each ratio.         "
},
{
  "id": "ratios-rates-proportions-exercises-2-2",
  "level": "2",
  "url": "Fractions-5.html#ratios-rates-proportions-exercises-2-2",
  "type": "Exercise",
  "number": "5.4.3.2",
  "title": "",
  "body": "  Classify each situation as a ratio , rate , or proportion , and write it accordingly.   There are 3 green marbles for every 4 blue marbles in the bag.  We have 20 marshmallows so we know there are 10 graham crackers.  grams of rice costs dollars.  In a bucket of gravel, there are 15 granite rocks per 7 basalt rocks.    "
},
{
  "id": "ratios-rates-proportions-exercises-2-3",
  "level": "2",
  "url": "Fractions-5.html#ratios-rates-proportions-exercises-2-3",
  "type": "Exercise",
  "number": "5.4.3.3",
  "title": "",
  "body": "  Determine whether each rate can be expressed as a unit rate (per 1). If not, simplify as far as possible. You may use decimals for unit rates.         "
},
{
  "id": "ratios-rates-proportions-exercises-2-4",
  "level": "2",
  "url": "Fractions-5.html#ratios-rates-proportions-exercises-2-4",
  "type": "Exercise",
  "number": "5.4.3.4",
  "title": "",
  "body": "  Form a proportion from each description and solve for the unknown. Simplify where appropriate.    There are 3 brown bears for every 1 black bear in the zoo. There are 7 black bears. How many brown bears?  Every shelf has 7 photos. There are 21 photos. How many shelves?    "
},
{
  "id": "ratios-rates-proportions-exercises-2-5",
  "level": "2",
  "url": "Fractions-5.html#ratios-rates-proportions-exercises-2-5",
  "type": "Exercise",
  "number": "5.4.3.5",
  "title": "",
  "body": "  Create your own scenario described by a ratio between two quantities, and specify a numerical request that is impossible because of that ratio. Explain why it is impossible.   "
},
{
  "id": "ratios-rates-proportions-exercises-2-6",
  "level": "2",
  "url": "Fractions-5.html#ratios-rates-proportions-exercises-2-6",
  "type": "Exercise",
  "number": "5.4.3.6",
  "title": "",
  "body": "  The ratio of blue to green gumballs in a surprise bag is .   If there are 16 blue gumballs, how many green gumballs are there?  A bag has 24 blue and 35 green gumballs. Is this consistent with the stated ratio? Explain.  Is it possible to have exactly 12 blue gumballs in a bag? Explain.  Is it possible to have exactly 6 blue gumballs in a bag? Explain.    "
},
{
  "id": "ratios-rates-proportions-exercises-2-7",
  "level": "2",
  "url": "Fractions-5.html#ratios-rates-proportions-exercises-2-7",
  "type": "Exercise",
  "number": "5.4.3.7",
  "title": "",
  "body": "  Mike drives at a speed of .   Is Mike’s speed a ratio, a rate, or a proportion?  He arrives after 3 hours. What distance did he travel?  Mike’s friend claims Mike traveled 20 km. Describe the setup error that leads to this conclusion.    "
},
{
  "id": "ratios-rates-proportions-exercises-2-8",
  "level": "2",
  "url": "Fractions-5.html#ratios-rates-proportions-exercises-2-8",
  "type": "Exercise",
  "number": "5.4.3.8",
  "title": "",
  "body": "  Pious is building a rectangular sheep pen with perimeter .   Store A (Bucket O’ Hammers) sells of fencing for . Store B (Screws, Nails and Everything Lumber) sells for . Pious doesn’t mind leftovers—he wants the best value. Which store should he choose?  How much will the fence cost at the chosen store?  If Pious wants to minimize leftover fencing instead, does the choice change? What is the cost now?  Suppose instead he wants a rectangular pen of area . What is the minimum fencing required, and which store yields the lowest cost?  Describe the general relationship between the target perimeter and the better store choice, considering potential leftovers.    "
},
{
  "id": "ratios-rates-proportions-exercises-2-9",
  "level": "2",
  "url": "Fractions-5.html#ratios-rates-proportions-exercises-2-9",
  "type": "Exercise",
  "number": "5.4.3.9",
  "title": "",
  "body": "  Ronald played basketball games with the following results.   On Tuesday he played 3 games, scoring 5, 3, and 7 baskets. What was his overall rate (baskets per game) as a unit rate?  On Wednesday his average was . If he scored 45 baskets in total, how many games did he play?  The next day his overall rate was over 4 games. He scored 7, 8, and 12 in three of them. How many in the fourth?  Is it possible for Ronald to have 30 total baskets with a rate of ? Explain.    "
},
{
  "id": "ratios-rates-proportions-exercises-2-10",
  "level": "2",
  "url": "Fractions-5.html#ratios-rates-proportions-exercises-2-10",
  "type": "Exercise",
  "number": "5.4.3.10",
  "title": "",
  "body": "  The payroll administrator at Bland Media Conglomerate LLC. reports wages and earnings in base twelve, while hours remain in base ten. Do not convert to base ten; work directly in the indicated bases.   After working 35 hours at , Julie received . Was there an error? What should she have been paid?  Greg worked 40 regular hours and 10 overtime hours. Overtime is paid at twice his regular wage. He was paid . What is his hourly rate (in base twelve)?  Jerry was paid . A fraction of his hours were at regular pay and the remaining were overtime. What is Jerry’s hourly wage (in base twelve)?  How many hours did Jerry work?    "
},
{
  "id": "fractions-explanations-2-1",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-1",
  "type": "Exercise",
  "number": "5.4.4.1",
  "title": "",
  "body": "  Fractions can mean different things in different contexts (part–whole, quotient, ratio, operator, measure). For each meaning, give a short real-world example for and explain why that meaning fits.   "
},
{
  "id": "fractions-explanations-2-2",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-2",
  "type": "Exercise",
  "number": "5.4.4.2",
  "title": "",
  "body": "  Two students claim that and are equivalent.   Explain why this is true by describing a visual model (area or number-line) in words.  Explain why this is true using a numerical argument about common factors and why your argument works in any base, not just base ten.    "
},
{
  "id": "fractions-explanations-2-3",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-3",
  "type": "Exercise",
  "number": "5.4.4.3",
  "title": "",
  "body": "  A student says: “Since and both have even numerators and denominators, because and .” Critique this reasoning carefully. Give a correct method to compare and and explain why it works.   "
},
{
  "id": "fractions-explanations-2-4",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-4",
  "type": "Exercise",
  "number": "5.4.4.4",
  "title": "",
  "body": "  (Mediant reasoning) Suppose and are positive fractions with . Explain why the fraction lies strictly between them. State any conditions you use (e.g., positivity) and justify in words and\/or symbols.   "
},
{
  "id": "fractions-explanations-2-5",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-5",
  "type": "Exercise",
  "number": "5.4.4.5",
  "title": "",
  "body": "  Explain why there are infinitely many fractions between and . Give a method that generates different examples on demand and explain why it always stays in the interval.   "
},
{
  "id": "fractions-explanations-2-6",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-6",
  "type": "Exercise",
  "number": "5.4.4.6",
  "title": "",
  "body": "  (Base-independence) A rule of simplification says: if , then . Explain why this statement is true regardless of the base used to write the digits of . Your explanation should separate “the quantities” from “their written representations.”   "
},
{
  "id": "fractions-explanations-2-7",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-7",
  "type": "Exercise",
  "number": "5.4.4.7",
  "title": "",
  "body": "  Error check: A learner writes     Identify the exact step where a property is misused. Then show two correct explanations for adding these fractions: (i) common denominator, (ii) visual model (describe the picture you would draw).   "
},
{
  "id": "fractions-explanations-2-8",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-8",
  "type": "Exercise",
  "number": "5.4.4.8",
  "title": "",
  "body": "  Explain why the rule “to convert a mixed number to an improper fraction, multiply the whole number by the denominator and add the numerator” is correct. Your explanation should work for an arbitrary , and may use a diagram or algebraic reasoning.   "
},
{
  "id": "fractions-explanations-2-9",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-9",
  "type": "Exercise",
  "number": "5.4.4.9",
  "title": "",
  "body": "  Multiplying fractions: Without doing any simplification first, explain why using an area model. Describe clearly how each factor is represented and why the overlapping region has the stated fraction of the whole.   "
},
{
  "id": "fractions-explanations-2-10",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-10",
  "type": "Exercise",
  "number": "5.4.4.10",
  "title": "",
  "body": "  Dividing by a fraction: Explain, using a measurement or sharing interpretation, why . Your explanation should make it clear why “multiply by the reciprocal” matches the story.   "
},
{
  "id": "fractions-explanations-2-11",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-11",
  "type": "Exercise",
  "number": "5.4.4.11",
  "title": "",
  "body": "  Cross-multiplication for comparison: To decide whether is greater than , one method forms and . Explain why this method is valid and how it relates to rewriting both fractions with a common denominator without actually finding the common denominator first.   "
},
{
  "id": "fractions-explanations-2-12",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-12",
  "type": "Exercise",
  "number": "5.4.4.12",
  "title": "",
  "body": "  (Betweeness via common denominators) Explain why, once two positive fractions are expressed with a common positive denominator, the one with the larger numerator is the larger fraction. Include a number-line interpretation that works even when the denominators are large.   "
},
{
  "id": "fractions-explanations-2-13",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-13",
  "type": "Exercise",
  "number": "5.4.4.13",
  "title": "",
  "body": "  (Fractions across bases) Explain why the statement is correct without converting any numbers into base ten. Describe the quantities each numeral represents in base four and how the equality follows from those quantities.   "
},
{
  "id": "fractions-explanations-2-14",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-14",
  "type": "Exercise",
  "number": "5.4.4.14",
  "title": "",
  "body": "  Least common denominator (LCD): A student always chooses the product of denominators as the common denominator. Explain when this is unnecessarily large, how to find a smaller LCD using prime factors, and why using the LCD can make computation and simplification clearer.   "
},
{
  "id": "fractions-explanations-2-15",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-15",
  "type": "Exercise",
  "number": "5.4.4.15",
  "title": "",
  "body": "  (Equivalent-fraction generation) Give a principled way to generate all fractions equivalent to . Explain why every fraction produced by your method is equivalent, and why any equivalent fraction must arise from your method.   "
},
{
  "id": "fractions-explanations-2-16",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-16",
  "type": "Exercise",
  "number": "5.4.4.16",
  "title": "",
  "body": "  (Order of operations with fractions) Consider . Explain two correct solution paths—one emphasizing order of operations first, and one rewriting everything over a common denominator—and justify why both lead to the same result.   "
},
{
  "id": "fractions-explanations-2-17",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-17",
  "type": "Exercise",
  "number": "5.4.4.17",
  "title": "",
  "body": "  (Reason about size) Without computing exact values, determine whether each expression is less than, equal to, or greater than , and explain your reasoning.        "
},
{
  "id": "fractions-explanations-2-18",
  "level": "2",
  "url": "Fractions-5.html#fractions-explanations-2-18",
  "type": "Exercise",
  "number": "5.4.4.18",
  "title": "",
  "body": "  (Complex fractions) Explain a clear strategy for simplifying that avoids arithmetic mistakes. Justify why your strategy works and describe how you would check your final answer for reasonableness.   "
},
{
  "id": "decimals",
  "level": "1",
...
},
{
  ...
  "number": "7.1.10",
  "title": "",
  "body": "  If a number is divisible by and a number is divisible by , and say that , then and are also divisible by .    We'll only prove the case for addition, and leave the case for subtraction as an exercise later. Assuming the if-part is true, assume that and for some natural numbers . We need to show that where the bracket is some natural number. Adding both equations together, Factoring out the a from the RHS, Since we know their sum too. Thus we have shown the then-part must be true and the theorem is proved.   "
},
{
  "id": "example-theorem3",
  "level": "2",
...
},
{
  ...
  "number": "7.2.11",
  "title": "",
  "body": "   What is the largest power of that is a factor of ? What about ? What about for some number ? Try factoring into its prime factors.    We know that . What can you say about whether for ? What theorem that we've proved justifies this?     Can you generalize the above idea to all powers of ? What can you say about which powers of it is a factor of?    How does this relate to digits of a number?    Using the ideas above, conjecture a divisibility rule for when a number is divisible by . What do you have to check?    Let's say you have an -digit number where the subscript of each digit is its place value. Using the proofs for and as a blueprint, prove the conjecture you made above.    "
},
{
  "id": "thm-DivBy5",
  "level": "2",
...
},
{
  ...
  "number": "7.2.14",
  "title": "",
  "body": " Consider the number . Since , we know that . Again, you can check this via long division.  "
},
{
...
},
{
  ...
  "number": "7.2.16",
  "title": "",
  "body": " In this example we will develop an intuition for a divisibility rule for and .    Using long division, so you can keep track of remainders, find . Now do the same thing for and .    What commonality do you notice about these answers? In each division, how many of each power of 10 are you able to group into groups of 3?    Now do the division in two ways; using long division, and then doing the division separately for each place value; that is, What can you say about the three remainders in the second case?    Using the above as a guide, describe a way to determine if a number is divisible by .    Now redo the work above replacing by . You should notice the exact same pattern.    "
},
{
  "id": "divisibility-3-9",
  "level": "2",
...
{
  "id": "subsubsec-WhenCompoundDivisibilityRulesWork-4",
  "level": "2",
  "url": "divisibility-theorems-small-numbers.html#subsubsec-WhenCompoundDivisibilityRulesWork-4",
  "type": "Checkpoint",
  "number": "7.2.25",
  "title": "",
...
{
  "id": "thm-CompoundDivisibility",
  "level": "2",
  "url": "divisibility-theorems-small-numbers.html#thm-CompoundDivisibility",
  "type": "Theorem",
  "number": "7.2.26",
  "title": "",
...
{
  "id": "subsubsec-WhenCompoundDivisibilityRulesWork-8",
  "level": "2",
  "url": "divisibility-theorems-small-numbers.html#subsubsec-WhenCompoundDivisibilityRulesWork-8",
  "type": "Checkpoint",
  "number": "7.2.27",
  "title": "",
...
},
{
  ...
  "number": "8.2.13",
  "title": "",
  "body": "  Let be a natural number. If is an th power then each exponent in its prime factorization has a factor of . If is not an th power, then there is a prime number in its prime factorization with an exponent with no factor of .   "
},
{
