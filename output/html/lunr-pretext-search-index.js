...
},
{
  ...
  "number": "2.2.14",
  "title": "",
  "body": " Let's solve the system    We will eliminate the variable . Note that in Equation I the coefficient of is 3, and in Equation II it is -1. To make them opposites, we multiply Equation II by 3:    Now Equation I is and our new equation is . If we add them, the -terms cancel:      Having found , we substitute into either original equation. Using Equation II:      Therefore, the solution is . Each step used only arithmetic operations on both sides of the equations and the fact that adding or subtracting equal quantities preserves equality—so the “elimination” of left us with a single-variable equation.  "
},
{
